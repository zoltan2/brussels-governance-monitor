...
const sectorSummaries: Record<string, Record<string, string>> = {
  fr: {
    ...
    transport: 'Le plan d\u2019investissement STIB, les arbitrages régionaux du Métro 3 et les nouvelles lignes étaient bloqués. Le Métro 3 a été suspendu pour 10 ans dans sa forme actuelle (coût : 4,76 Mrd EUR, dépassement de +477 %).',
    ...
    digital: 'La stratégie Smart City, les subsides d\u2019inclusion numérique et les incitants startups étaient gelés. 36 % de vulnérabilité numérique (~340 000 Bruxellois), sans nouvelle impulsion politique.',
  ...
  nl: {
    ...
    transport: 'Het MIVB-investeringsplan, de regionale arbitrages voor Metro 3 en nieuwe lijnen waren geblokkeerd. Metro 3 werd in zijn huidige vorm voor 10 jaar opgeschort (kosten: 4,76 Mrd EUR, overschrijding van +477 %).',
    ...
    digital: 'De Smart City-strategie, digitale inclusiesubsidies en startup-incentives waren bevroren. 36 % digitale kwetsbaarheid (~340.000 Brusselaars), zonder nieuwe politieke impuls.',
  ...
  en: {
    ...
    transport: 'The STIB investment plan, regional Metro 3 arbitrations and new lines were blocked. Metro 3 was suspended for 10 years in its current form (cost: 4.76 bn EUR, +477% overrun).',
    ...
    digital: 'The Smart City strategy, digital inclusion subsidies and startup incentives were frozen. 36% digital vulnerability (~340,000 Brussels residents), without new policy impetus.',
  ...
  de: {
    ...
    transport: 'Der STIB-Investitionsplan, die regionalen Metro-3-Schiedsverfahren und neue Linien waren blockiert. Metro 3 wurde in seiner aktuellen Form für 10 Jahre ausgesetzt (Kosten: 4,76 Mrd. EUR, +477 % Überschreitung).',
    ...
    digital: 'Die Smart-City-Strategie, Zuschüsse für digitale Inklusion und Startup-Anreize waren eingefroren. 36 % digitale Verwundbarkeit (~340.000 Brüsseler), ohne neuen politischen Impuls.',
