        ...
        <div className="mb-10 rounded-lg bg-neutral-50 p-6">
          ...
          <div className="grid grid-cols-2 gap-4 sm:grid-cols-4">
            <div className="flex flex-col items-center gap-2 text-center">
              <svg className="h-7 w-7 text-brand-800" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" d="M5.25 14.25h13.5m-13.5 0a3 3 0 0 1-3-3m3 3a3 3 0 1 0 0 6h13.5a3 3 0 1 0 0-6m-16.5-3a3 3 0 0 1 3-3h13.5a3 3 0 0 1 3 3m-19.5 0a4.5 4.5 0 0 1 .9-2.7L5.737 5.1a3.375 3.375 0 0 1 2.7-1.35h7.126c1.062 0 2.062.5 2.7 1.35l2.587 3.45a4.5 4.5 0 0 1 .9 2.7" /></svg>
              <span className="text-xs font-medium text-neutral-700">{t('pillarHosting')}</span>
            </div>
            <div className="flex flex-col items-center gap-2 text-center">
              <svg className="h-7 w-7 text-brand-800" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" d="m21 21-5.197-5.197m0 0A7.5 7.5 0 1 0 5.196 5.196a7.5 7.5 0 0 0 10.607 10.607Z" /></svg>
        ...
        <div className="mb-10 grid gap-5 sm:grid-cols-2">
          ...
          <div className="rounded-lg border border-neutral-200 bg-neutral-50 p-5 text-center">
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-2 rounded-lg bg-brand-900 px-8 py-3 text-sm font-semibold text-neutral-50 shadow-sm transition-all hover:bg-brand-800 hover:shadow-md"
            >
              {t('donateButton')}
