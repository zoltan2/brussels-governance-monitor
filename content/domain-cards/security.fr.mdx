...
changeType: updated
changeSummary: "Saint-Gilles : escalade de violences liées à la drogue — 3 incidents en 4 nuits (15-18 avril) : explosion rue de Bosnie (~10 véhicules), tirs rue Gisbert Combaz (3 impacts vitres, sans victime), explosion bar OKLM Chicha rue Théodore Verhaegen avec école Institut des Filles de Marie touchée (15 vitres soufflées, sans victime). Bourgmestre Spinette (PS) : scène « hallucinante », évoque une « gangrène ». Renforcement du dispositif policier, moyens fédéraux supplémentaires."
