...
changeType: updated
changeSummary: "Tension sociale dans le secteur : le 15 juin, le personnel de neuf des douze entreprises de travail adapté bruxelloises a fait grève, faute d'accord sectoriel sur les chèques-repas, alors que la plupart de ces travailleurs sont rémunérés autour du salaire minimum ; les employeurs auraient quitté la table des négociations (FGTB et CSC). Pour rappel : désescalade du 3 juin sur le volet titres-services, avec une période de transition de cinq ans (2027-2032) via un appel à mandat ESMI ouvert jusqu'au 10 juillet (14 structures, 400 emplois menacés selon le gouvernement, 735 selon le secteur, budget 19 M€)."
---
