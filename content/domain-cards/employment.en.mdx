...
changeType: updated
changeSummary: "Brussels left out of the flexi-job boom: of the quarter of a million Belgians who held a flexi-job in 2025 (national social security figures), barely 3.2% live in the capital — against 82.9% in Flanders. The federal level nonetheless wants to extend the scheme to all sectors from July, now requiring sectors to conclude an agreement in order to opt out. Also in the news: the Social Summit of 11 June sealed 17 shared priorities between the Brussels government and the social partners, including stronger support for jobseekers — steering committees expected by September."
