...
> **Note**: The official text of the DPR has not yet been published. The measures below are drawn from corroborating press sources (RTBF, La Libre, DH, BX1, VRT NWS, BRUZZ). They will be updated once the official document is released.
