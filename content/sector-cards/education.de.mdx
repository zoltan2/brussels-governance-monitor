...
humanImpact: "Das Abkommen kündigt ein Beschäftigungsziel von 70 %, eine verkürzte Actiris-Frist auf 3 Monate und eine verstärkte Zweisprachigkeit an. Die Berufsausbildung und die seit Juni 2024 eingefrorenen zweisprachigen Projekte können wieder aufgenommen werden. DPR noch nicht veröffentlicht."
lastModified: "2026-02-14"
---

## Regierungsabkommen: angekündigte Auswirkungen

> **Hinweis**: Der offizielle Text der DPR wurde noch nicht veröffentlicht. Die nachstehenden Maßnahmen stammen aus übereinstimmenden Pressequellen (RTBF, La Libre, DH, BX1, VRT NWS, BRUZZ). Sie werden aktualisiert, sobald das offizielle Dokument verfügbar ist.
...
Schulrenovierungsprojekte, die nicht formell festgelegt waren (öffentliche Ausschreibungen gestartet, Budgets zugewiesen) vor Juni 2024, sind blockiert:
...
Die Budgets für regionale Subventionen an innovative Bildungsprojekte -- Digitalisierung in der Schule, Bekämpfung des Schulabbruchs, berufliche Eingliederung von Jugendlichen -- sind eingefroren:
