...
faq:
  ...
  - q: "Who is eligible for BIM status in Brussels?"
    a: "BIM is aimed at low-income households. There are two routes. Granting is **automatic** for recipients of certain social benefits (CPAS integration income, GRAPA pension top-up, disability allowances). It is **application-based** for other households below an income ceiling, after review by the health insurance fund. In Brussels, where precariousness is more pronounced than elsewhere in the country, the share of beneficiaries is markedly higher."
    sources:
      - label: "INAMI : increased reimbursement, better coverage of medical costs"
        url: "https://www.inami.fgov.be/fr/themes/soins-de-sante-cout-et-remboursement/facilites-financieres/intervention-majoree"
        accessedAt: "2026-06-17"
...
changeType: updated
changeSummary: "The MR bill tightening BIM criteria remains blocked in the Chamber after the 3-4 June 2026 political incident, in which federal Social Affairs Minister Frank Vandenbroucke accused the MR, N-VA and Anders of 'hypocrisy' on the matter, following the revelation that a health insurance fund had solicited Middle Classes Minister Éléonore Simonet (MR) about the BIM status. Since 1 July 2026, the ban on billing supplement fees to BIM beneficiaries has extended to all outpatient dental procedures, whether the dentist is under agreement or not."
---
