...
stakeholders:
  ...
  - name: "Union syndicale STIB (CSC Transcom / CGSP)"
    type: union
humanImpact: "L'accord annonce le gel du Métro 3 pour 10 ans, le remplacement de Good Move et le maintien de la LEZ (pass 350 EUR/an, amende réduite à 80 EUR). 430 millions de voyages annuels seraient concernés par cette réorientation. DPR non encore publiée."
...
Depuis le 9 juin 2024, ces leviers sont gelés. Le réseau fonctionne, mais il ne peut plus évoluer.
...
Le risque est celui d'un chantier à **deux vitesses** : la composante fédérale (Beliris) qui décide et investit, et la composante régionale (STIB/Région) qui ne peut plus arbitrer les choix stratégiques qui lui incombent.
