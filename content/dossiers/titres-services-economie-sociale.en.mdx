...
changeType: updated
changeSummary: "Social tension in the sector: on 15 June, the staff of nine of the twelve Brussels sheltered-work enterprises went on strike for lack of a sector agreement on meal vouchers, as most of these workers are paid around the minimum wage; the employers reportedly left the negotiating table (FGTB and CSC). For the record: the 3 June de-escalation on the service voucher front, with a five-year transition period (2027-2032) via an ESMI mandate call open until 10 July (14 structures, 400 jobs at risk according to the government, 735 according to the sector, budget €19M)."
---
