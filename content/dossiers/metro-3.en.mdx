...
changeType: updated
changeSummary: "The special Metro 3 committee nears its end: on 11 June, the former Minister-President defended before MPs the choices made since 2013 — in his view, inflation, unpredictable subsoil and the absence of reasonable bids are risks inherent to major construction projects, not negligence. The former Finance and Urban Planning officials, heard the same day, did not contradict this account but consider that no relaunch of the project will happen without the private sector. Final hearing on 18 June: the current Minister for Mobility and State Secretary for Urban Planning."
---
