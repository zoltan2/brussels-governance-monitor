...
faq:
  ...
  - q: "Führt die Reform zu Entlassungen von Beamten ?"
    a: "Es werden keine Entlassungen angekündigt. Der wichtigste Mechanismus beruht auf einem Einstellungsstopp : Abgänge (Pensionierungen, Kündigungen) werden nicht ersetzt, interne Mobilität wird bevorzugt und die Lohnmasse sinkt durch natürliche Fluktuation. Experten betonen, dass dieser Prozess langsam und unsicher ist, was den angestrebten Sparkurs belastet."
    sources:
...
changeType: updated
changeSummary: "Das Mandat des Generaldirektors von perspective.brussels (Antoine de Borman) ist seit dessen Ablauf vakant, da die Regierung wegen der angekündigten Fusion mit urban.brussels noch nicht über eine Verlängerung entschieden hat; eine Personalversammlung am 11. Juni 2026 äußerte Besorgnis, ohne dass bislang eine Abschaffungsentscheidung für den Posten angekündigt wurde (anders als beim Europakommissariat). Zuvor: Der Minister für den öffentlichen Dienst, Dirk De Smedt, hatte am 3. Juli die Einführung eines regionalen «pool de compétences» angekündigt, um überzähliges Personal umzuleiten, sozialer Dialog ab dem 14. Juli 2026; die Senkung der Beratungskosten (bis zu 67 Mio. EUR/Jahr bis 2029) bleibt ein zentraler Hebel des Sparkurses."
---
