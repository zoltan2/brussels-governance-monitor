...
changeType: updated
changeSummary: "Brussels reindustrialisation: the government mandated on 6 June the minister for Employment and Economy to negotiate a competitiveness pact with the federal level targeting the former Audi site — levers: reduction of payroll tax for companies on the site and clarification of the DPR's free zones perimeter. Previously: Actiris May 2026 — 93,732 job seekers (−1,657 on the month, −1.7%), including a 28% drop in insured unemployed due to the federal reform; personal services (titres-services) — 5-year transition period (2027-2032) granted to social economy enterprises."
