...
metrics:
  ...
  - label: "Umsatz Peymey Diffusion ASBL (operative Muttergesellschaft)"
    value: "985 337"
    unit: "€ (2024) — 10 VZÄ — Basis 2024; das Festivalbudget 2026 übersteigt diesen Betrag voraussichtlich angesichts der Rekordbesucherzahlen (60.000 Zuschauer), aggregierte Gesamtsumme nicht veröffentlicht"
  ...
  - label: "Ausgabe 44 — Daten und Ort"
    ...
    url: "https://www.brussels-expo.com/en/event/bifff-2026/"
    date: "2026-04-03"
  - label: "Zuschuss Stadt Brüssel — Entwurf einer mehrjährigen Vereinbarung Peymey Diffusion (Ausgaben 2026, 2027, 2028, zur Abstimmung am 20. April 2026)"
    value: "250 000"
    unit: "€/Jahr — 150 000 Kabinett des Bürgermeisters + 100 000 Schöffenamt Kultur — Haushaltsartikel 76201/33202 und 77210/33202 — unter Vorbehalt der Abstimmung im Gemeinderat vom 20. April 2026, anschließend regionale Aufsicht"
    source: "Gemeinderat Stadt Brüssel, 20. April 2026, Punkt 62"
    url: "https://www.bruxelles.be/sites/default/files/bxl/workflow/20-04-2026/20%2004%202026%20OJ%20point_punt%20%28062%29/062_Arr%C3%AAt%C3%A9%20Conseil.pdf"
    date: "2026-04-20"
  - label: "Prognostizierte mehrjährige öffentliche Finanzierung (FWB + Stadt Brüssel)"
    value: "370 000"
    unit: "€/Jahr — 120 000 FWB Centre du Cinéma (konventioniert) + 250 000 Stadt Brüssel (Vereinbarungsentwurf, zur Abstimmung am 20. April 2026) — Gemeinschaftskanal konventioniert, kommunaler Kanal in Erwartung der Abstimmung, regionale Kanäle (visit.brussels) weiterhin diskretionär"
...
alerts:
  ...
  - label: "RABKO: 120+ Institutionen fordern, die Brüsseler Kultur nicht zu opfern"
    severity: warning
    date: "2026-03-07"
  - label: "Entwurf der Vereinbarung Stadt-Peymey 2026-2028 zur Abstimmung im Gemeinderat vom 20. April 2026 (anschließend regionale Aufsicht, auflösende Bedingung)"
    severity: warning
    date: "2026-04-20"
confidenceLevel: official
dprCommitment: "Die Brüsseler Regierungsvereinbarung 2026-2029 nennt das BIFFF nicht namentlich. Die Kultur wird transversal behandelt (Lesen, Tanz, Barrierefreiheit, Senioren), ohne eigene Linie für Filmfestivals. Die Kürzungen bei visit.brussels (−64 % bis 2029) und der Abbau des Budgets « Image de Bruxelles » treffen das Festival indirekt, ohne dass eine Ausnahmemaßnahme vorgesehen wäre. Der kommunale Kanal (Stadt Brüssel) ist dagegen Gegenstand eines Entwurfs einer mehrjährigen Vereinbarung von 250 000 €/Jahr für die Ausgaben 2026-2028, zur Abstimmung im Gemeinderat vom 20. April 2026, Punkt 62."
faq:
  - q: "Was ist das BIFFF?"
    a: "Das BIFFF (Brussels International Fantastic Film Festival) ist ein Brüsseler Festival des fantastischen Films, getragen von zwei frankophonen ASBL. Vierzig Jahre nach seiner Gründung findet es in Brussels Expo statt (Palais 10, auf dem Heysel-Plateau). Sein englischer Name ist eine strategische Wahl, um die Brüsseler Sprachtrennlinie FR/NL zu überbrücken."
    sources:
  ...
  - q: "Wer finanziert das BIFFF?"
    a: "Das BIFFF ruht auf mehreren öffentlichen Machtebenen. Zwei konventionierte Kanäle strukturieren seine Finanzierung: die Fédération Wallonie-Bruxelles über das Centre du Cinéma (gemeinschaftliche Festivalbeihilfe) und die Stadt Brüssel über eine mehrjährige kommunale Vereinbarung. Ein regionaler Kanal (visit.brussels) ergänzte diesen Sockel lange. Keine öffentliche Finanzierung stammt aus der niederländischsprachigen Seite."
    sources:
  ...
  - q: "Ist die Finanzierung des BIFFF fragil?"
    a: "Das Festival ist an seiner Basis doppelt geschützt durch zwei konventionierte mehrjährige Kanäle (Gemeinschaft FWB und kommunal Stadt Brüssel), bleibt aber auf dem regionalen Kanal exponiert, der diskretionär und jährlich ist und als erster von der Brüsseler Sparpolitik getroffen wurde. Die Verantwortlichen des Festivals warnen die öffentlichen Stellen seit Langem vor der Kluft zwischen konstanten Subventionen und steigenden Kosten."
    sources:
...
changeType: updated
changeSummary: "Bilanz 44. Ausgabe (Abschluss 18. April 2026): 60.000 Zuschauer (+30 %, +12.000 gegenüber Vorjahresausgabe ~48.000) — Rekord seit der Rückkehr zum Heysel nach COVID. Kohärenz-Update nach der Bilanz: Vergangenheitsform für Passagen, die vor dem Abschluss verfasst wurden; Neuformulierung des Absatzes « Bruchpunkt » (das Rekordpublikum widerlegt die Hypothese der erzwungenen Schrumpfung); Neuklassifizierung der Vereinbarung Stadt Brüssel als « Entwurf, zur Abstimmung im Gemeinderat vom 20. April 2026 » (Abstimmung am 19. April noch ausstehend); Präzisierung, dass der Peymey-Umsatz 2024 eine Basis 2024 und keine Untergrenze für das Festival 2026 ist; qualitative Erwähnung der Ticketverkäufe als bedeutende Einnahmequelle."
draft: false
---
