...
changeType: updated
changeSummary: "The governance crisis at the Foyer anderlechtois worsens: according to the press, an extraordinary board meeting on 15 June voted to temporarily remove the chair, a decision deemed 'non-compliant' by the body's management, and the SLRB threatens to take direct control under its mission of supervising social housing companies. La Libre has also published documents pointing to a parallel allocation system via an elected officials' messaging channel (elements to be confirmed, contested procedures). Previously: the audit of the Saint-Josse social rental agency (AISSJ) reported irregularities in 86% of the files examined, fuelling the debate on extending the inquiry committee to the whole sector."
---
