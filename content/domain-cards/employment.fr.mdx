...
summary: "L'accord annonce un objectif de taux d'emploi de 70 % en fin de législature, avec une activation renforcée, un bilan de compétences obligatoire et la promotion du bilinguisme FR/NL. Les 98 458 DEI et 42 000 exclusions restent le contexte. DPR officielle non encore publiée — mesures issues de presse."
sectors:
  - associatif
  - construction
sources:
...
changeSummary: "Accord de gouvernement : statut delayed → ongoing, objectif emploi 70 %, activation renforcée, bilinguisme obligatoire"
...
Selon les sources de presse concordantes, l'accord du 12 février 2026 annonce des objectifs ambitieux en matière d'emploi :
