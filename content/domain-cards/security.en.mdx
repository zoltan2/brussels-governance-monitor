...
changeType: updated
changeSummary: "Brussels firefighters: in an unusual move, the management and the joint union front together asked the regional government on 11 June for an immediate structural refinancing of the SIAMU (Brussels fire and emergency medical service). According to their statement, the recruitment freeze no longer offsets departures: emergency calls handled more slowly, rescue vehicles out of service for lack of staff, mandatory training not organised. The move extends the standoff over the shift reorganisation plan (daily staffing cut from 161 to 153) and sharpens the tension with the SIAMU reinforcement commitment in the government agreement."
