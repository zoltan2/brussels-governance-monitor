...
metrics:
  ...
  - label: "Blootgestelden aan vliegtuiglawaai in Europa (Lden >55 dB)"
    ...
    date: "2025-06-24"
alerts:
  - label: "Het Gewest overweegt aan te sluiten bij de gerechtelijke procedures tegen RNP-07L (Persoons, 12 mei 2026)"
    severity: warning
    date: "2026-05-12"
...
changeType: updated
changeSummary: "De Brusselse burgemeesters zullen de federale minister van Mobiliteit begin juni 2026 ontmoeten over de hinder van de nieuwe aanvliegroute (BRUZZ, 19 mei). De gewestelijke minister van Veiligheid roept publiekelijk het Vlaams Gewest op zijn verantwoordelijkheid op te nemen rond Brussels Airport (BRUZZ, 18 mei). Op de achtergrond: het voorstel van de Brusselse staatssecretaris op 12 mei om aan te sluiten bij de gerechtelijke procedures van de gemeenten tegen de RNP-07L."
---
...
## Gerechtelijke escalatie: het Gewest overweegt een procedure (mei 2026)

De Brusselse staatssecretaris **Ans Persoons (Vooruit, Leefmilieu)** kondigde op **12 mei 2026** aan dat zij de Brusselse regering zal voorstellen **aan te sluiten bij de gerechtelijke procedures van de gemeenten tegen de RNP-07L** (vordering tot staking).

De maatregel is nog niet formeel beslist: Persoons heeft de intentie uitgesproken om dit voor te stellen aan de ministerraad. Als de procedure aansluit bij de bestaande procedures van de gemeenten, zou dit de gerechtelijke druk op de federale overheid aanzienlijk vergroten.

**Context**: de RNP-07L treft naar schatting **~450.000 Brusselaars** (schatting gemeenschappelijk front van de burgemeesters). De volgende gemeenten hebben al gerechtelijke stappen ondernomen: **Koekelberg**, **Sint-Jans-Molenbeek**, **Schaarbeek**, **Evere** en **Anderlecht**. **Brussel-Stad** — waarvan de noordelijke wijken (Noordwijk, Thurn & Taxis, noord van Laken buiten de koninklijke perimeter) ook in de aanvliegcorridor 07L liggen — heeft **(nog) geen** gerechtelijke procedure aangespannen op 28 mei 2026.

**Institutionele herinnering**: de luchtvaartbevoegdheid (routes, banen) is federaal (FOD Mobiliteit, minister Crucke). Het Gewest is bevoegd voor geluid (Leefmilieu Brussel, ordonnantie van 27 mei 1999). Het aansluiten bij een gerechtelijke procedure impliceert dat het Gewest optreedt in zijn milieuhoedanigheid, niet als luchtvaartregulator.

Bron: [BRUZZ Politiek (12 mei 2026)](https://www.bruzz.be/actua/gezondheid/ans-persoons-stelt-voor-dat-brussels-gewest-juridische-stappen-zet-tegen-vliegroute-2026-05-12). Betrouwbaarheid: official.
