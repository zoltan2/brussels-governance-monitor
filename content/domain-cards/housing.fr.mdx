...
metrics:
  ...
  - label: "Loyer moyen marché privé"
    value: "1 346"
    unit: "€/mois (+2 % sur un an)"
    source: "Federia (contrats 2025)"
    date: "2025-12-31"
  - label: "Surpeuplement"
    value: "31%"
  ...
  - label: "Nouveaux baux signés (2024)"
    value: "-20%"
    unit: "de nouveaux contrats locatifs malgré la forte demande"
    source: "Investropa / marché locatif bruxellois"
    date: "2024-12-31"
lastModified: "2026-02-10"
changeType: updated
changeSummary: "Ajout : nouveaux baux -20% en 2024, loyers +2,8% S1 2024 (Investropa)"
...
Malgré la forte demande, le nombre de **nouveaux baux signés a chuté de 20 % en 2024** par rapport à l'année précédente. Les loyers ont augmenté de **2,8 % au premier semestre 2024**. Le marché locatif bruxellois, composé à environ 90 % d'appartements, montre des signes de blocage : les propriétaires hésitent à relouer face à l'incertitude réglementaire (contrôle des loyers), tandis que les locataires restent en place faute d'alternative abordable.
