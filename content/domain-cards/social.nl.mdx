...
changeType: updated
changeSummary: "Brusselse non-profitsector: in de nasleep van de nationale mobilisatie van 6 juni (na de stemming van het FWB-begrotingsdecreet) luiden werkgevers- en werknemersvertegenwoordigers de alarmbel — meerdere Brusselse verenigingen blijven geconfronteerd met budgettaire onzekerheden ondanks de installatie van de nieuwe gewestregering (conventies en erkenningen nog niet gestabiliseerd). Eerder: betoging op 4 juni in Brussel (meerdere duizenden werknemers uit gezondheidszorg, welzijn en socioculturele sector) voor een federaal sociaal akkoord en herfinanciering van de ACS-sector."
