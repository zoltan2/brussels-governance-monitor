...
changeSummary: "The deadline in this file has changed, and not through a political decision. On Wednesday 29 July 2026, the Council of State annulled the licences in force for free-floating shared scooters and bikes, following an appeal by Lime, the operator excluded from the market when they were awarded. Brussels Mobility immediately wrote to Dott, Bolt and VOI asking them to remove their vehicles from public space by Tuesday 1 September 2026 at the latest. The ban on shared scooters that the government had set for 1 January 2027 is not annulled: it is brought forward by four months, by a judge. For shared bikes, which the government wanted to keep, a new regulatory framework has yet to be written, with no announced timetable. The Villo! concession is not affected."
