...
humanImpact: "Das Abkommen kündigt eine Verwaltungsreform (Zusammenlegung der Säulen) an, die die COCOM/GGC und Iriscare betreffen wird, sowie einen regionalen Drogenbeauftragten. Die Haushaltsbemühungen werden die Wiederaufnahme der Zulassungen, Vereinbarungen und des Obdachlosenplans bestimmen. DPR noch nicht veröffentlicht."
lastModified: "2026-02-14"
---

## Regierungsabkommen: angekündigte Auswirkungen

> **Hinweis**: Der offizielle Text der DPR wurde noch nicht veröffentlicht. Die nachstehenden Maßnahmen stammen aus übereinstimmenden Pressequellen (RTBF, La Libre, DH, BX1, VRT NWS, BRUZZ). Sie werden aktualisiert, sobald das offizielle Dokument veröffentlicht wird.
