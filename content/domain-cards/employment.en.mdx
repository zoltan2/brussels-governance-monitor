...
changeType: updated
changeSummary: "Employment May 2026: 93,732 jobseekers in Brussels (−1,657 over the month, −1.7%), but above all a 28% drop in benefit-entitled unemployed — which Actiris attributes to the federal reform time-limiting benefits, not to an improvement in employment: those reaching end of rights stay registered under other statuses. Service vouchers: a five-year transition period (2027-2032) granted to social-economy firms via a mandate call open until 10 July (14 organisations, 400 jobs at risk per the government, €19M)."
