...
changeType: updated
changeSummary: "Brüssel bleibt beim Flexi-Job-Boom außen vor: Von der Viertelmillion Belgier, die 2025 einen Flexi-Job ausgeübt haben (LSS-Zahlen), wohnen nur 3,2 % in der Hauptstadt — gegenüber 82,9 % in Flandern. Die Föderalregierung will das System dennoch ab Juli auf alle Sektoren ausweiten und verpflichtet die Sektoren künftig, ein Abkommen zu schließen, um es abzulehnen. Weitere Aktualität: Der Sozialgipfel vom 11. Juni hat 17 gemeinsame Prioritäten zwischen der Brüsseler Regierung und den Sozialpartnern besiegelt, darunter die Stärkung der Begleitung der Arbeitsuchenden — Lenkungsausschüsse bis September erwartet."
