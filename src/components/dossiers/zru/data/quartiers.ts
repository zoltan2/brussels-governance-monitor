...
export const PROVENANCE_QUARTIERS: Provenance = {
  ...
  modifications: {
    ...
    en: [
      'Statbel tax income statistics, published by the Monitoring des Quartiers (indicator 2498)',
      '2023 edition, the latest year shown by the Monitoring des Quartiers; amounts in euros',
    ...
    de: [
      'Einkommensteuerstatistik von Statbel, veröffentlicht vom Monitoring des Quartiers (Indikator 2498)',
      'Jahrgang 2023, das letzte vom Monitoring des Quartiers angezeigte Jahr; Beträge in Euro',
