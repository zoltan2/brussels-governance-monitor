...
changeType: updated
changeSummary: "Hub.brussels muss 3M€/Jahr einsparen: Brussels Houses Mailand/Barcelona von Schließung bedroht."
...
Der Haushalt 2026 der Region Brüssel entzieht der Agentur **Visit Brussels** **5,7 Millionen EUR** an Handlungsmitteln — eine direkte Folge der regionalen Sparmaßnahmen. Die Agentur, die **150 Mitarbeiter** beschäftigt, ist für die Förderung des Freizeit- und Geschäftstourismus in der Hauptstadt zuständig, einem Sektor, der rund **10 Millionen Übernachtungen pro Jahr** generiert.

Diese Kürzung kommt zur Erhöhung der **Hotel-MwSt.** (6 % → 12 %, 1. März 2026) hinzu und bildet eine doppelte Belastung für die touristische Attraktivität Brüssels.

Quelle: Le Soir (März 2026). URL nicht verifizierbar (geschützte Website).
