...
humanImpact: "Het akkoord kondigt een nieuw mobiliteitsplan aan, het behoud van de LEZ met een jaarlijkse pass, de afschaffing van de Renolution-premies en belastingverlagingen (personenbelasting -1 %, abattement verhoogd). Deze maatregelen raken de 60 000 Brusselse handelszaken. DPR nog niet gepubliceerd."
lastModified: "2026-02-14"
---

## Regeringsakkoord: de aangekondigde impact

> **Opmerking**: De officiële tekst van de DPR is nog niet gepubliceerd. De onderstaande maatregelen zijn afkomstig van overeenstemmende persbronnen (RTBF, La Libre, DH, BX1, VRT NWS, BRUZZ). Ze worden bijgewerkt zodra het officiële document is gepubliceerd.
