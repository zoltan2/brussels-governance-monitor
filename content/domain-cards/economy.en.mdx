...
changeType: updated
changeSummary: "Reindustrialisation: the government mandated on 6 June the minister for Economy to negotiate a competitiveness pact with the federal level around the former Audi site — reduction of payroll tax for companies located there, geographic clarification of the DPR's free zones. Previously: action plan for Square convention centre (Mont des Arts) relaunched in alliance with the Royal Library and neighbouring museums; Shopera dissolved; Kanal EUR 60 million regional loan; Brussels Airport first dividend in seven years."
