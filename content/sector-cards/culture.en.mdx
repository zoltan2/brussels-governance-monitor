...
humanImpact: "~15,000 cultural jobs in Brussels are weakened by the freeze on regional subsidies. However, the majority of cultural funding comes from the community level (FWB, Flemish Community) and continues to operate."
...
The Brussels cultural sector is experiencing a scissors effect: the freeze on regional levers combines with the erosion of community funding (non-indexation) and federal cuts. None of these factors taken in isolation is fatal, but their accumulation weakens the ecosystem.

The regional freeze is silent, gradual and cumulative. Each season without an active regional cultural policy reduces inter-level coordination capacity and the complementary resources available for specifically Brussels-based projects.

Main sources: RAB/BKO, report 2025 and policy watch February 2026; COCOF, budget and activity report 2025; VGC, annual report 2024; IBSA, sectoral economic data.
