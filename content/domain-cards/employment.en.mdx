...
changeType: updated
changeSummary: "The Brussels Parliament voted on 3 July to abolish the Activa scheme (€27M/year, 9,447 beneficiaries in 2025); current entitlements are maintained until 31 December 2026 and a new, \"better targeted\" scheme is announced for 2027 (see the dedicated dossier). The same day, Actiris published its June figures: a 14.6% unemployment rate, 93,445 registered jobseekers (+3% year-on-year), and 34,137 CPAS registrants, up 83.5% year-on-year. Previously: the French-speaking labour court of Brussels ruled on 30 June that three Uber Eats couriers were validly self-employed; Actiris published its new shortage-occupation list (103 occupations, including pastry chef making its entry)."
