...
changeType: updated
changeSummary: "Brulocalis : 1,718 Mrd EUR de charges reportées sur les communes (2025-2029), 26,7 % compensés. Collège Bruxelles-Ville remanié (Zian échevin, Ben Hamou récupère Culture)."
...
- **Pensions du personnel statutaire** — augmentation non compensée des cotisations
- **Financement des zones de police** — transfert de charges fédérales
- **Réforme fiscale** — perte de recettes communales estimée à 17 M EUR/an dès 2029
- **CPAS** — afflux lié à la réforme du chômage (voir carte Social)
