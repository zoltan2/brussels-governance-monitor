...
changeType: updated
changeSummary: "De gewestregering activeerde op 28 mei 2026 het dwangtoezicht over Sint-Joost — eerste concrete toepassing van het luik « versterkt toezicht op de gemeentefinanciën » uit het GBV, wegens een gemeentelijk tekort van meer dan 30 miljoen EUR volgens het Gewest (betwist door de gemeente). Diezelfde dag huiszoekingen van het parket in het dossier van de Anderlechtse Haard (sociale huisvesting): de gewestmeerderheid is verdeeld in aanloop naar de stemming van maandag 1 juni over de oprichting van een parlementaire onderzoekscommissie. Op de achtergrond keurde het Parlement het Cocom-budget 2026 goed (22 mei) na zeventien maanden voorlopige twaalfden."
...
Diezelfde dag voerde het **Brusselse parket huiszoekingen** uit in het dossier van de **Anderlechtse Haard** (sociale huisvestingsmaatschappij, SISP), op de zetel en bij de voorzitter thuis. Er loopt een corruptieonderzoek; de vermoedens van cliëntelisme bij de toewijzing van sociale woningen, naar aanleiding van een Pano-reportage (VRT), zijn op dit ogenblik **niet bevestigd** (vermoeden van onschuld). In commissie hield de staatssecretaris voor Huisvesting vol dat « de procedures werden gerespecteerd ». Een **stemming over de oprichting van een parlementaire onderzoekscommissie** (tekst van MR en Anders) is gepland op **maandag 1 juni**; ze **verdeelt de gewestmeerderheid** (de PS is tegen), honderd dagen na het aantreden van de regering.
