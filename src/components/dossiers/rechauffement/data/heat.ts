...
export const HEAT_COUNTERS: HeatCounter[] = [
  {
    ...
    valeur: { fr: '+4,5 °C', nl: '+4,5 °C', en: '+4.5 °C', de: '+4,5 °C' },
    label: {
      fr: 'îlot de chaleur, vers 23 h en moyenne en été',
      nl: "stedelijk hitte-eiland, rond 23u gemiddeld in de zomer",
      en: 'urban heat island, around 23:00 on average in summer',
      de: 'städtische Hitzeinsel, gegen 23 Uhr im Sommerdurchschnitt',
    },
    detail: {
      fr: "centre de la Région contre zones rurales voisines, +3 °C le jour (étude VITO 2018) ; jusqu'à 10 °C en conditions extrêmes dans les villes en général (Bruxelles Environnement)",
      nl: 'centrum van het Gewest tegenover landelijke omgeving, +3 °C overdag (studie VITO 2018) ; tot 10 °C in extreme omstandigheden in steden in het algemeen (Leefmilieu Brussel)',
      en: 'Region centre versus nearby rural areas, +3 °C during the day (VITO 2018 study) ; up to 10 °C in extreme conditions in cities in general (Brussels Environment)',
      de: 'Zentrum der Region gegenüber ländlichem Umland, +3 °C tagsüber (Studie VITO 2018) ; bis zu 10 °C unter extremen Bedingungen in Städten allgemein (Brüssel Umwelt)',
    },
    confiance: 'official',
  },
  {
  ...
  },
  {
    ...
    detail: {
      fr: "été le plus meurtrier des vingt années précédentes en Belgique (Sciensano) ; Bruxelles région la plus touchée à l'été 2025",
      nl: "dodelijkste zomer van de twintig voorgaande jaren in België (Sciensano) ; Brussel meest getroffen gewest in de zomer van 2025",
      en: 'deadliest summer of the previous twenty years in Belgium (Sciensano) ; Brussels most affected region in summer 2025',
      de: 'tödlichster Sommer der vorangegangenen zwanzig Jahre in Belgien (Sciensano) ; Brüssel am stärksten betroffene Region im Sommer 2025',
    },
    confiance: 'official',
  },
];
