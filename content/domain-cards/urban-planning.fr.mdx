...
changeType: updated
changeSummary: "Auderghem déclare la guerre aux grands projets immobiliers régionaux : la commune va financer un cabinet d'avocats pour bloquer systématiquement les projets qu'elle juge trop denses (liste noire établie). Le secteur de la construction dénonce une cacophonie institutionnelle commune/région. En parallèle, le gouvernement bruxellois présente de grandes ambitions pour le plateau du Heysel (congrès-centre de rang international)."
