        ...
        <div className="mx-auto max-w-7xl px-6 py-16 md:py-24">
          <div className="grid gap-12 md:grid-cols-[auto_1fr] md:gap-20 md:items-center">
            ...
            <div className="text-center md:text-left">
              ...
              <p className="mt-3 font-mono text-[120px] font-bold leading-none tabular-nums text-neutral-900 md:text-[180px]">
                12
              </p>
              ...
              <a
                href="#"
                className="mt-8 inline-flex items-center gap-2 rounded-full bg-neutral-900 px-5 py-2.5 font-mono text-xs uppercase tracking-[0.18em] text-neutral-50 transition hover:bg-neutral-800"
              >
                Lire le digest
            ...
            <div>
              <p className="mb-4 font-mono text-[10px] uppercase tracking-[0.22em] text-neutral-500">
