...
changeType: updated
changeSummary: "Actiris × VDAB triple their joint scheme supporting Brussels residents into jobs in the Flemish periphery (2,000 → 6,000 people supported, 19 May). Threat of mass redundancies in Brussels service vouchers, two ministers passing the buck (18-19 May). 7,631 newcomers are currently on an integration pathway in Brussels."
