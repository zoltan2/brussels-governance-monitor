...
changeType: updated
changeSummary: "Molenbeek is preparing a budgetary recovery plan that would cut 40 jobs, including 20 at the CPAS (municipal welfare centre), and reduce the staff's end-of-year bonus — even as the number of people supported by the CPAS has risen from 7,300 to 8,500 since the federal unemployment reform. The service fighting the digital divide will be drastically reduced; the 13 recently recruited social workers are spared. Previously: asbestos in the Machtens towers (~200 social housing units), demolition planned without a rehousing plan."
---
