...
changeType: updated
changeSummary: "The French-speaking labour court of Brussels ruled on 30 June that three Uber Eats couriers were validly self-employed, rejecting their claim to be reclassified as employees, a ruling the ACV/CSC union calls a step backward from the 2024 position of the Administrative Commission for the Regulation of Labour Relations and from several recent rulings in the opposite direction. Separately, Actiris published its new shortage-occupation list for Brussels on 1 July: 103 occupations, including pastry chef making its entry, down from 106 last year. Previously: first measurement of the welfare spillover, with 28.1% of Brussels residents excluded from unemployment actually turning to a public welfare centre - CPAS over the first three waves."
