...
stakeholders:
  ...
  - name: "hub.brussels"
    type: agency
    url: "https://hub.brussels/"
humanImpact: "Das Abkommen kündigt einen neuen Mobilitätsplan an (als Ersatz für Good Move), die Beibehaltung der LEZ mit einem Jahrespass und die Stärkung von Actiris. Diese Maßnahmen betreffen unmittelbar die 35 000 Arbeitsplätze und 9 000 Betriebe des Sektors. DPR noch nicht veröffentlicht. Die föderale MwSt.-Erhöhung auf Hotelübernachtungen (6 % → 12 %, 1. März 2026) belastet den Sektor zusätzlich."
...
> **Hinweis**: Der offizielle Text der DPR wurde noch nicht veröffentlicht. Die nachstehenden Maßnahmen stammen aus übereinstimmenden Pressequellen (RTBF, La Libre, DH, BX1, VRT NWS, BRUZZ). Sie werden aktualisiert, sobald das offizielle Dokument vorliegt.
