  ...
  return (
    <main className="mx-auto max-w-6xl px-6 py-12">
      <header className="mb-10 border-b border-neutral-200 pb-6">
        ...
        <h1 className="mt-2 text-3xl tracking-tight text-neutral-900">
      ...
      <section className="mb-12">
        <h2 className="mb-4 font-mono text-xs uppercase tracking-[0.22em] text-neutral-500">
          Compteurs par axe
        </h2>
        <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
          {Object.entries(stats.breakdown).map(([axis, options]) => {
            ...
            return (
              ...
              >
                <p className="mb-3 text-sm font-semibold tracking-tight text-neutral-900">
                      ...
                      .map(([opt, n]) => {
                        ...
                        return (
                          <tr key={opt}>
                            ...
                            <td className="w-12 py-1 pl-2 text-right font-mono text-xs tabular-nums text-neutral-700">
                              {n}
                            </td>
                          </tr>
                        );
            ...
            <table className="w-full text-sm">
              <thead className="bg-neutral-50">
                <tr className="text-left">
                  <th className="px-3 py-2 font-mono text-[10px] uppercase tracking-wider text-neutral-500">
                    Date
                  </th>
                  <th className="px-3 py-2 font-mono text-[10px] uppercase tracking-wider text-neutral-500">
                    Hero
              ...
              <tbody>
                {stats.recent.map((v) => (
                  <tr key={v.id} className="border-t border-neutral-100">
                    ...
                    <td className="px-3 py-2 max-w-md text-neutral-600">
                      {v.comment || (
                        <span className="text-neutral-300">—</span>
                      )}
                    </td>
