...
metrics:
  ...
  - label: "44th edition attendance (final tally, close on 18 April 2026)"
    value: "60 000"
    unit: "spectators — +30% / +12,000 vs previous edition (~48,000) — record since the post-COVID return to Heysel"
...
changeType: updated
changeSummary: "44th edition final tally (close on 18 April 2026): 60,000 spectators (+30%, +12,000 vs previous edition ~48,000) — record since the post-COVID return to Heysel. The economic re-engineering under constraint (a single hall, 16 days, three weekends) did not depress attendance — it pushed it to a peak. Awards: Golden Raven (Corbeau d'Or) to Never After Dark (Dave Boyle, Japan)."
draft: false
---
