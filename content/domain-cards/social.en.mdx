...
changeType: updated
changeSummary: "Samusocial — pilot project 'Nozat' launched on 20 April 2026 at the women's shelter: beer and wine now permitted in the ground-floor common areas (locked fridge, forbidden in bedrooms), additional staff member present for three months. Justification (Sarah de Liamchine, general director): strict prohibition could be 'experienced as infantilising'. Objectives: harm reduction (rushed consumption before curfew) and more humane reception. No change in capacity or funding. Baseline context unchanged: Vivalis Social Barometer 2025 (15 April) — poverty 23%, 47 304 integration income recipients on 1/1/2025, 55 572 households on social housing waiting list, homeless count +25% in 2 years (9 777), 14 246 Brussels students on integration income."
