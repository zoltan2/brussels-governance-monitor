...
changeType: updated
changeSummary: "A loophole in the low emission zone is now documented: classic vehicles (« O » plate, over thirty years old) are automatically exempt, with no check on actual use, and their number in the zone has more than tripled, from 3,936 in 2019 to 13,799 in 2024; vehicles driving one hundred days a year or more rose from 17 to 156. The figures, communicated by the State Secretary for the Environment in response to a parliamentary question, feed the debate ahead of the LEZ reform targeted for early 2027; the 2025 figure is excluded as it is skewed by a camera replacement operation. Previously: the government approved in first reading two social exemption scenarios for BIM beneficiaries, and EUR 350 fines take effect on 1 July for more than 13,000 Euro 5 diesel and Euro 2 petrol vehicles."
---
