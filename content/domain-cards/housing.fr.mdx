...
summary: "L'accord annonce 400M EUR pour la SLRB, 1 000+ logements publics, le doublement de Be Home (320 EUR) et le remplacement de Renolution par des prêts à taux zéro (200M EUR). Les friches seraient arbitrées (moratoire 18 mois sur 4 sites). DPR officielle non encore publiée — mesures issues de presse."
sectors:
  - construction
  - social
sources:
...
changeSummary: "Accord de gouvernement : statut blocked → ongoing, SLRB 400M, 1 000+ logements, Be Home doublé, Renolution → prêts zéro"
...
L'accord du 12 février 2026 annonce un déblocage massif pour le logement :
