...
seoTitle: "Regierungserbe: 20 Monate ohne Regionalregierung"
...
Im Jahr 2024 erhielten rund **47.000 Personen** das RIS in der Region Brüssel (Quelle: IBSA / ÖPD Soziale Eingliederung). Diese Zahl weist einen strukturellen Aufwärtstrend auf.
...
Beim Konklave zur Regierungsbildung (10. Februar 2026) kündigten MR und Les Engages an, den **Good-Move-Plan in seiner jetzigen Form grundlegend umgestalten** zu wollen. Die Maßnahme wird von Groen angefochten, das den Plan verteidigt. Die von der MR gestartete Anti-Good-Move-Website (7. Februar 2026) verdeutlicht die politische Polarisierung um das Thema. Die Zukunft von Good Move hängt unmittelbar vom Ausgang der Regierungsbildungsverhandlungen ab.
