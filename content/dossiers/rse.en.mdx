...
seoTitle: "Economic transition: Shifting Economy, labels, reporting"
slug: rse
locale: en
...
decisionLevel: mixed
summary: "The Shifting Economy aims to reserve regional subsidies for exemplary businesses by 2030, but only 188 sites out of 118,000 businesses (0.16%) hold the Ecodynamic label. On 16 June 2026, 107 businesses received the label, an annual record since 1999 according to the Environment cabinet. A label increases regional subsidies by 2.5% to 45%. The Omnibus I Directive, in force since 18 March 2026, reduces CSRD scope by around 80%."
...
sources:
  ...
  - label: "La Libre — 142 B Corp companies in Belgium, according to BetterBusiness (April 2026)"
    ...
    accessedAt: "2026-06-12"
  - label: "Cabinet of Ans Persoons — Over 100 Brussels businesses recognised for sustainability (16-17 June 2026)"
  ...
  - label: "DH — Record in Brussels: 107 businesses obtain the Ecodynamic label (17 June 2026)"
...
metrics:
  ...
  - label: "Ecodynamic label growth 2024"
    ...
    date: "2024-12-31"
  - label: "Businesses labelled at the 16 June 2026 ceremony"
    value: "107"
    unit: "record since the label was created in 1999 (relation to the 188-site total not specified by sources)"
    source: "Cabinet of Ans Persoons / DH"
    date: "2026-06-16"
  ...
  - label: "CSRD scope reduction (Omnibus I)"
    ...
    date: "2026-02-24"
alerts:
  - label: "Record 107 businesses awarded the Ecodynamic label in a single ceremony, highest total since 1999 (16 June 2026)"
    severity: info
    date: "2026-06-16"
...
faq:
  ...
  - q: "Does my Brussels company have to publish a CSRD sustainability report ?"
    a: "It depends on its size and on the transposition timetable. Sustainability reporting (CSRD) falls under European law. The Omnibus I Directive (EU) 2026/470, in force since 18 March 2026, sharply raises the thresholds : only companies exceeding both 1,000 employees and EUR 450 million in turnover will remain in scope. Belgium must transpose these provisions by 19 March 2027, for first application to financial years starting on or after 1 January 2027 ; until then, wave 1 remains in force as it has since January 2025 and waves 2 and 3 are postponed to 2028-2029. The vast majority of Brussels companies will therefore fall below the threshold, while remaining encouraged to commit through the regional incentives of the Shifting Economy."
    sources:
  ...
  - q: "What is the difference between a Brussels regional label and B Corp certification ?"
    a: "Regional labels such as Ecodynamic or Good Food are awarded by Brussels Environment and assess environmental management (energy, waste, mobility, sustainable food), to which the Ecodynamic label added social criteria in 2025 to align with the Shifting Economy. B Corp certification is international, issued by the organisation B Lab, and assesses a company's overall impact (governance, employees, community, environment, customers). In Brussels, both families of labels are recognised under the exemplarity mechanism."
    sources:
      - label: "Brussels Environment, Ecodynamic Enterprise label"
        url: "https://environnement.brussels/pro/gestion-environnementale/devenir-plus-durable/le-label-entreprise-ecodynamique-valorisez-vos-actions-pour-lenvironnement"
        accessedAt: "2026-06-17"
...
changeSummary: "Two FAQ answers have been corrected. The one on CSRD reporting no longer states in the present tense that companies below the threshold are no longer required to publish : it sets out the timetable, with Belgian transposition due by 19 March 2027 and first application to financial years starting on or after 1 January 2027, wave 1 remaining in force and waves 2 and 3 postponed to 2028-2029. The one on labels notes that the Ecodynamic label added social criteria in 2025."
