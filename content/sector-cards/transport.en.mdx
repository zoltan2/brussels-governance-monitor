---
title: "Public transport: Metro 3 frozen 10 years, new mobility plan"
slug: transport
locale: en
...
frozenMechanisms:
  - name: "STIB investment plan"
    description: "The STIB's multi-year investment plan cannot be renewed or adapted: only prior commitments are being executed."
    since: "2024-06-09"
  - name: "Regional Metro 3 arbitrations"
    description: "Metro 3 construction continues, but regional political decisions (STIB/Region) on the route, regional budget and timeline are suspended. Federal decisions via Beliris continue independently."
    since: "2024-06-09"
  - name: "New lines and frequencies"
    description: "No decisions can be taken on creating new bus or tram lines, nor on increasing service frequencies."
    since: "2024-06-09"
  - name: "Fares and accessibility"
    description: "Decisions on social fares and network accessibility measures cannot be taken."
    since: "2024-06-09"
activeMechanisms:
...
impactIndicators:
  ...
  - label: "STIB annual budget"
    ...
    url: "https://www.stib-mivb.brussels/"
    frequency: "annual"
  - label: "Estimated cost of Metro 3 (Gare du Nord - Bordet)"
    value: "~EUR 3.2bn"
    source: "Beliris / Brussels-Capital Region"
...
stakeholders:
  ...
  - name: "STIB trade unions (CSC Transcom / CGSP)"
    type: union
humanImpact: "The agreement freezes Metro 3 for 10 years, replaces Good Move with a new mobility plan and maintains the LEZ (pass EUR 350/year, fine reduced to EUR 80). 430 million annual journeys are affected by this strategic reorientation."
...
**Beliris**, the federal cooperation agreement that co-finances Metro 3, continues to operate independently of the regional crisis. Federal investment decisions, public contracts managed by Beliris and the technical monitoring of the construction site continue. The project therefore advances on its federal component, but the regional governance component is frozen.

The risk is that of a construction site operating at **two speeds**: the federal component (Beliris) that decides and invests, and the regional component (STIB/Region) that can no longer arbitrate the strategic choices within its remit.
