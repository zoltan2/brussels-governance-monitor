...
sources:
  - label: "RTBF — Drought: Vivaqua activates the water reserves of two quarries (13 August 2026)"
  ...
  - label: "BX1 — Drought: Vivaqua asks some of its customers to limit their consumption (14 August 2026)"
...
faq:
  - q: "Who manages water in Brussels ?"
  ...
  - q: "What is Vivaqua ?"
    a: "Vivaqua is the Brussels **intermunicipal utility** for water : it produces and distributes drinking water, collects wastewater and maintains an extensive pipeline network, part of which is ageing. It also carries a multi-year investment plan to renew the network and improve its resilience to heavy rainfall. Historically owned by the municipalities, its governance is due to open to a regional stake: on 11 June 2026 the Brussels government took the decision in principle to inject 180 million EUR and become a 49 % shareholder, with the legal texts not yet published."
    sources:
      - label: "Vivaqua, official website"
        url: "https://www.vivaqua.be/"
        accessedAt: "2026-06-17"
  - q: "Who sets the price of water in Brussels ?"
    a: "Water tariffs in Brussels are framed by **BRUGEL**, the Brussels regulator for energy and water. BRUGEL reviews the costs Vivaqua may pass on to the bill and can exclude expenses it deems unjustified. The final price therefore reflects both Vivaqua's investment needs and the regulator's analysis, rather than a unilateral decision by the operator."
    sources:
      - label: "BX1, the water bill and the regulator's role"
        url: "https://bx1.be/categories/news/la-facture-de-leau-augmente-a-bruxelles-mais-le-regulateur-pointe-la-mauvaise-gestion-de-vivaqua/"
        accessedAt: "2026-06-17"
  - q: "Is there a social water tariff in Brussels ?"
    a: "Yes : households with **BIM** status (beneficiary of increased intervention) can obtain a reduction on their water bill, and a **Social Water Fund** helps households in difficulty through the CPAS welfare offices. Eligibility generally requires a step with the CPAS, which can lead to non-take-up. Civil-society voices argue for a more automatic social tariff modelled on other Regions."
    sources:
      - label: "IEB, opinion on the challenges of Brussels water policy"
        url: "https://www.ieb.be/IMG/pdf/2025.11.14_avis-d-ieb-sur-les-futurs-enjeux-de-la-politique-bruxelloise-de-l-eau.pdf"
        accessedAt: "2026-06-17"
lastModified: "2026-09-22"
changeType: corrected
changeSummary: "FAQ correction: the answer to “What is Vivaqua?” presented the opening of its governance to the Region as completed; it now recalls that this is a decision in principle of 11 June 2026 (180 million EUR, 49 %), with the legal texts unpublished. Two corrections in the body: the regional stake in the “Government agreement” section moves from 49.99 % to 49 %, in line with the rest of the dossier, and 31 % of Brussels residents are at risk of poverty, the usual indicator, rather than living below the poverty line."
...
- **180M EUR recapitalisation** : the Region takes a **49 %** stake in Vivaqua's capital, the February agreement having initially announced 49.99%
...
- **31 % of Brussels residents** are at risk of poverty (Xavier May, Belgian Observatory of Inequalities, April 2024)
...
## August 2026 drought: Vivaqua activates the reserves of two quarries (13 and 14 August 2026)

In mid-August 2026, the combination of **drought** and **heatwave** placed Vivaqua in a situation its spokesperson describes as uncomfortable. Consumption is rising sharply across all three Regions.

### The pressure point: the flow of the Meuse at Tailfer

The **Tailfer** plant, on the Meuse, turns river water into drinking water and is one of the pillars of Brussels' supply. For more than a week the **flow of the Meuse at Tailfer has been falling** and is approaching the **19 m³/s** threshold. Below that level, the plant's output would be **significantly limited**.

### The measures taken

- **Activation of the reserves of two quarries**, at **Écaussinnes** and **Ligny**, to offset the lower flow and higher demand.
- **A call for restraint** from Vivaqua to customers in **Wallonia** and **Flanders**.
- **Fifteen Walloon municipalities** have issued water use restriction orders.

### What this says about this dossier

The episode illustrates a structural feature that is rarely visible: **Brussels' drinking water supply depends very largely on catchments and facilities located outside the Region**. A Walloon hydrological constraint therefore feeds directly into Vivaqua's production capacity.

**At this stage, no restriction specific to the Brussels Region has been announced or documented.** The recorded orders concern Walloon municipalities, and the call for restraint targets customers outside the Region. It should not be inferred that restrictions apply to Brussels residents.

The 19 m³/s threshold is the useful checkpoint for the continuation of this dossier.

Sources: [RTBF (13 August 2026)](https://www.rtbf.be/article/secheresse-pas-de-nouvelle-mesure-en-wallonie-vivaqua-active-les-reserves-d-eau-de-deux-carrieres-11769970) ; [BX1 (14 August 2026)](https://bx1.be/categories/news/secheresse-pression-sur-la-disponibilite-de-leau-vivaqua-demande-a-certains-de-ses-clients-de-limiter-leur-consommation/). Confidence: unconfirmed (statements by Vivaqua's spokesperson relayed by two press sources; no primary release published by the intermunicipal company).
