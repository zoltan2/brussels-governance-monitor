...
changeType: updated
changeSummary: "Samusocial — Pilotprojekt « Nozat » am 20. April 2026 im Frauenaufnahmezentrum gestartet: Bier und Wein sind nun in den Gemeinschaftsräumen im Erdgeschoss erlaubt (abschließbarer Kühlschrank, in den Zimmern verboten), eine zusätzliche Begleitperson ist drei Monate lang anwesend. Begründung (Sarah de Liamchine, Generaldirektorin): Das strikte Verbot könne « als infantilisierend empfunden werden ». Ziele: Schadensminderung (hastiger Konsum vor der Ausgangssperre) und Humanisierung der Aufnahme. Keine Änderung der Kapazität oder Finanzierung. Unveränderter Kontext: Vivalis-Sozialbarometer 2025 (15. April) — Armut 23 %, 47 304 Eingliederungseinkommen-Bezieher zum 1.1.2025, 55 572 Haushalte auf Warteliste Sozialwohnung, Obdachlose +25 % in 2 Jahren (9 777), 14 246 Brüsseler Studenten mit Eingliederungseinkommen."
