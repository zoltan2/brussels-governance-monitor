...
changeType: updated
changeSummary: "Militäreinsatz vor jüdischen Schulen und Synagogen (Quintin/Francken, 16. März). Kontext Post-Anschlag Lüttich + Bedrohungsstufe 3."
...
Die Task-Force des Hotspot Nordbahnhof (Schaerbeek/Saint-Josse) hat ihre erste vollständige Sitzung im März 2026 abgehalten. Mehrere Maßnahmen wurden angekündigt:

- **Obligatorische Geschäftsschließung** zwischen 1h und 6h — Gemeindeerlass in beiden Gemeinden in Vorbereitung
...
- **Straßenbaumaßnahmen** zur Reduktion der Belästigungen

Diese Maßnahmen befinden sich im Ankündigungsstadium: Die Gemeindeerlasse wurden noch nicht veröffentlicht.

Quelle: BX1 (März 2026). URL zu bestätigen.
