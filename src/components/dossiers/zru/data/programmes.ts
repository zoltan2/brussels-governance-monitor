...
const EVALUE_CQ: Record<Locale, string> = {
  fr: "Audit de la Cour des comptes sur les six premiers contrats de quartier (initiés en 1994) : contrôle de légalité et de régularité des dépenses, rapport définitif envoyé le 28 février 2001 (158e Cahier, 12e Cahier d'observations, pages 14 à 59). Dernière évaluation d'ensemble, confiée à BDO pour Bruxelles Urbanisme & Patrimoine, avril 2018 : 12 contrats de quartier et 22 contrats de quartier durables entrepris entre janvier 2007 et janvier 2017, conclusion : des interventions pertinentes par rapport aux besoins des Bruxelloises et des Bruxellois, mais sans l'amplitude suffisante pour influencer structurellement les indicateurs régionaux.",
  nl: 'Audit van het Rekenhof over de eerste zes wijkcontracten (gestart in 1994): wettigheids- en regelmatigheidscontrole van de uitgaven, definitief verslag verzonden op 28 februari 2001 (158e Boek, 12e Boek met opmerkingen, bladzijden 14 tot 59). Laatste globale evaluatie, toevertrouwd aan BDO voor Brussel Stedenbouw en Erfgoed (urban.brussels), april 2018: 12 wijkcontracten en 22 duurzame wijkcontracten gestart tussen januari 2007 en januari 2017, conclusie: ingrepen die relevant zijn voor de behoeften van de Brusselaars, maar zonder voldoende omvang om de gewestelijke indicatoren structureel te beïnvloeden.',
  en: 'Audit by the Belgian Court of Audit on the first six neighbourhood contracts (started in 1994): a legality and regularity check of the expenditure, final report sent on 28 February 2001 (158th Cahier, 12th Cahier of observations, pages 14 to 59). Last overall evaluation, entrusted to BDO for Brussels Urbanism and Heritage (urban.brussels), April 2018: 12 neighbourhood contracts and 22 sustainable neighbourhood contracts started between January 2007 and January 2017, conclusion: interventions relevant to the needs of Brussels residents, but without sufficient scale to structurally influence regional indicators.',
  de: 'Prüfung durch den belgischen Rechnungshof zu den ersten sechs Quartiersverträgen (gestartet 1994): Rechtmäßigkeits- und Ordnungsmäßigkeitsprüfung der Ausgaben, Abschlussbericht übermittelt am 28. Februar 2001 (158. Cahier, 12. Cahier d’observations, Seiten 14 bis 59). Letzte Gesamtevaluierung, in Auftrag gegeben an BDO für Bruxelles Urbanisme & Patrimoine (urban.brussels), April 2018: 12 Quartiersverträge und 22 nachhaltige Quartiersverträge, begonnen zwischen Januar 2007 und Januar 2017, Fazit: Maßnahmen, die dem Bedarf der Brüsselerinnen und Brüsseler entsprechen, deren Umfang jedoch nicht ausreicht, um die regionalen Indikatoren strukturell zu beeinflussen.',
};
