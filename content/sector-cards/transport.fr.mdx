...
stakeholders:
  ...
  - name: "Union syndicale STIB (CSC Transcom / CGSP)"
    type: union
humanImpact: "L'accord gèle le Métro 3 pour 10 ans, remplace Good Move par un nouveau plan de mobilité et maintient la LEZ (pass 350 EUR/an, amende réduite à 80 EUR). 430 millions de voyages annuels sont concernés par cette réorientation stratégique."
...
L'accord du 12 février 2026 opère un virage historique pour le transport public bruxellois :
