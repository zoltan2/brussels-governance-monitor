...
changeType: updated
changeSummary: "The shift of people excluded from unemployment benefits towards the CPAS is no longer a projection, it is measured. According to the SPP Social Integration report for January to June 2026, 11,843 Brussels residents reaching the end of their entitlement obtained an integration income, out of 26,990, or 43.9 %. Wallonia stands at 48.8 %, Flanders at 34.3 %, the national average at 44 %. The federal government had initially assumed one third. This dossier previously cited the ONEM projection of 35,799 Brussels residents excluded across the whole of 2026; the first-half figures now provide an actual measurement, and the fourth and fifth waves of exclusion began on 1 July."
draft: true
---
