...
changeType: updated
changeSummary: "Nachtleben, blockierte Subventionen, König-Baudouin-Stadion. Der Ausschuss für territoriale Entwicklung des Brüsseler Parlaments hat die sogenannte « agent of change »-Verordnung verabschiedet (10 Ja-Stimmen, 5 Enthaltungen) und überträgt damit die Lärmlast auf neue Wohnbauten, wenn diese sich neben einem bestehenden Nachtbetrieb ansiedeln. Am 23. April bleiben die Jahressubventionen von IEB (24 k€) und BRAL (45 k€) seit drei Wochen eingefroren — durch das LEZ-Abkommen nicht freigegeben. Die Stadt Brüssel und die Region bitten den Bund, die Sanierung des König-Baudouin-Stadions mitzufinanzieren."
