...
changeType: updated
changeSummary: "Veille #1 : tunnel Loi-Belliard gelé (161M, permis obtenus), Metro 3 commission spéciale + dépassement 255% + horizon 2034+"
...
En revanche, une **commission spéciale du Parlement bruxellois** (fin 2025) a révélé un **dépassement budgétaire de 255 %** par rapport au budget initial, avec un horizon de livraison repoussé à **2034 au plus tôt**. L'extension vers Bordet (la partie la plus ambitieuse) nécessite des décisions politiques nouvelles :
