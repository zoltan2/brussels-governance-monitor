...
export const PROVENANCE_QUARTIERS: Provenance = {
  ...
  modifications: {
    fr: [
      ...
      `${SANS} quartiers non habités ou trop peu peuplés sans valeur publiée\u00a0: laissés vides, jamais à zéro`,
    ...
    nl: [
      ...
      `${SANS} onbewoonde of te dun bevolkte wijken zonder gepubliceerde waarde: leeg gelaten, nooit op nul`,
    ...
    en: [
      ...
      `${SANS} uninhabited or too sparsely populated neighbourhoods with no published value: left blank, never set to zero`,
    ...
    de: [
      ...
      `${SANS} unbewohnte oder zu dünn besiedelte Viertel ohne veröffentlichten Wert: leer gelassen, nie auf null gesetzt`,
