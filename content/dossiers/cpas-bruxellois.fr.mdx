...
L'effectif consolidé des 19 CPAS bruxellois est d'environ 6 500 ETP, soit un ordre de grandeur comparable à celui de la STIB ou d'un grand hôpital régional. Les données les plus récentes consolidées par Bruxelles Pouvoirs locaux (Focus #14, situation au 30 juin 2023) confirment plusieurs traits structurels :
