...
changeType: updated
changeSummary: "The municipalities of Schaerbeek and Saint-Josse-ten-Noode are extending the night-time closure of businesses in the Quartier Brabant by three months, until the end of September 2026, adapting it based on field feedback: Schaerbeek relaxes the closing time to 3am on weekends and the evenings before public holidays (municipal council vote on 26 June), while Saint-Josse votes on 30 June without changing the hours but excluding Rue Royale from the perimeter. The local councils justify the renewal by a drop in the share of violent incidents committed between 1am and 6am, and are extending the accompanying tax exemptions. Previously: the regional government had confirmed the creation of a regional drugs commissioner on 16 June and approved a Stations Plan of ten million per year for the North and Midi."
