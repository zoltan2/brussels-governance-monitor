  ...
  if (submitState.status === 'success') {
    return (
      <section className="rounded-lg border border-neutral-200 bg-neutral-50 p-8 text-center">
        <h2 className="text-2xl text-neutral-900">Merci.</h2>
    ...
    <form onSubmit={handleSubmit} className="space-y-16">
      ...
      <section className="border-t border-neutral-200 pt-12">
        ...
        <fieldset className="mt-8 space-y-3">
          <legend className="font-mono text-xs uppercase tracking-[0.22em] text-neutral-500">
        ...
        <button
          type="submit"
          className="mt-10 inline-flex items-center gap-3 rounded bg-neutral-900 px-6 py-3 font-mono text-sm uppercase tracking-[0.18em] text-neutral-50 transition hover:bg-neutral-800 focus:outline-none focus:ring-2 focus:ring-neutral-900 focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-40"
          disabled={
...
function Option({
  ...
  return (
    <div
      className={`group relative flex flex-col rounded-lg border-2 bg-neutral-50 p-5 transition ${
        checked
    ...
    >
      <label className="cursor-pointer">
        <input
          ...
          className="sr-only"
        />
        <div className="mb-4 flex h-40 items-center justify-center overflow-hidden rounded bg-neutral-50">
          {children}
        </div>
        <div className="flex items-start justify-between gap-3">
          <h3 className="text-lg text-neutral-900">{label}</h3>
          <span
            aria-hidden
            className={`mt-1 flex h-5 w-5 shrink-0 items-center justify-center rounded-full border-2 ${
              checked ? 'border-neutral-900 bg-neutral-900' : 'border-neutral-300 bg-neutral-50'
            }`}
          >
            {checked && <span className="h-2 w-2 rounded-full bg-neutral-50" />}
          </span>
        </div>
      ...
      {previewHref && (
        <Link
          ...
          className="mt-4 inline-flex w-fit items-center gap-2 rounded border-2 border-neutral-900 bg-neutral-900 px-4 py-2 font-mono text-xs uppercase tracking-[0.18em] text-neutral-50 transition hover:bg-neutral-50 hover:text-neutral-900"
        >
...
function ProductionMockup({ variant }: { variant: ProductionVariant }) {
  if (variant === 'digest') {
    return (
      <div className="flex h-full w-full flex-col justify-center bg-neutral-900 p-4 text-neutral-50">
        ...
        <span className="mt-3 font-mono text-[10px] uppercase tracking-wider text-neutral-50/50">
          ~5 min · FR / NL / EN / DE
        </span>
      </div>
    );
  ...
  if (variant === 'magazine') {
    return (
      <div className="flex h-full w-full flex-col justify-center bg-amber-50 p-4">
        ...
        <p className="mt-2 text-sm leading-tight text-neutral-900">
  ...
  if (variant === 'quiz') {
    return (
      <div className="flex h-full w-full flex-col justify-center border border-emerald-200 bg-neutral-50 p-4">
        ...
        <span className="mt-3 font-mono text-[10px] uppercase tracking-wider text-neutral-500">
  ...
  if (variant === 'multilingue') {
    return (
      <div className="flex h-full w-full flex-col justify-center bg-neutral-50 p-4">
        ...
        <div className="mt-2 flex flex-wrap gap-1">
          {['FR', 'NL', 'EN', 'DE', 'IT', 'ES', '+6'].map((l) => (
            <span
              key={l}
              className="rounded border border-neutral-300 px-1.5 py-0.5 font-mono text-[9px] text-neutral-600"
            >
              {l}
            </span>
          ))}
  ...
  return (
    <div className="flex h-full w-full flex-col justify-center bg-neutral-50 p-4">
      ...
      <div className="mt-3 grid grid-cols-3 gap-1">
        <span className="rounded-sm bg-neutral-900 py-1 text-center font-mono text-[8px] uppercase tracking-wider text-neutral-50">
          Digest
        </span>
        ...
        <span className="col-span-2 rounded-sm border border-dashed border-neutral-300 py-1 text-center font-mono text-[8px] uppercase tracking-wider text-neutral-500">
          12 langues
        </span>
      </div>
    </div>
...
function CardSampleMockup({ variant }: { variant: CardVariant }) {
  ...
  if (variant === 'minimal') {
    return (
      <div className="flex h-full w-full flex-col justify-center border-l-2 border-neutral-900 bg-neutral-50 p-4">
  ...
  if (variant === 'standard') {
    return (
      <div className="flex h-full w-full flex-col justify-center bg-neutral-50 p-4">
        ...
        <h4 className="text-sm font-semibold leading-tight tracking-tight text-neutral-900">
    ...
    <div className="flex h-full w-full flex-col justify-between bg-neutral-50 p-4">
      <div>
        <div className="mb-1.5 flex items-center justify-between">
          ...
          <span className="rounded-sm bg-neutral-100 px-1.5 font-mono text-[8px] uppercase tracking-wider text-neutral-700">
            Dossier SLRB
          </span>
        </div>
        <h4 className="text-sm font-semibold leading-tight tracking-tight text-neutral-900">
      ...
      <div>
        <div className="grid grid-cols-3 gap-1.5 border-t border-neutral-100 pt-1.5">
          <span className="font-mono text-[9px] tabular-nums text-neutral-700">
            <strong className="text-neutral-900">39 000</strong> dem.
          </span>
          <span className="font-mono text-[9px] tabular-nums text-neutral-700">
            <strong className="text-neutral-900">0</strong> livr. 26
          </span>
          <span className="font-mono text-[9px] tabular-nums text-neutral-700">
...
function ToneSampleCopy({ title, lead }: { title: string; lead: string }) {
  return (
    <div className="flex h-full w-full flex-col justify-center px-4 text-left">
      ...
      <p className="mt-1.5 text-[11px] leading-snug text-neutral-600 md:text-xs">
        {lead}
      </p>
    </div>
  );
  ...
  return (
    <div className="w-full px-4">
      <div className="mb-2 flex items-baseline justify-between">
        ...
        <span className="font-serif text-xl text-neutral-900">{value}<span className="text-xs text-neutral-500">/100</span></span>
      </div>
...
function MosaicMockup() {
  return (
    <div className="grid h-full w-full grid-cols-2 gap-1.5 p-3">
      <div className="flex flex-col justify-between rounded bg-neutral-900 p-2 text-neutral-50">
      ...
      <div className="flex flex-col justify-between rounded bg-amber-50 p-2">
        ...
        <span className="font-serif text-[10px] leading-tight text-neutral-900">
          #17
        </span>
      </div>
...
function StrongTextMockup() {
  return (
    <div className="flex h-full w-full items-center justify-center px-4">
      <p className="text-sm leading-tight text-neutral-900 md:text-base">
        186 nationalités.
        <br />
        <span className="text-neutral-500">19 communes.</span>
        <br />
        Une seule région.
      </p>
    </div>
...
function MultilingualMockup() {
  ...
  return (
    <div className="flex h-full w-full flex-col justify-center px-4">
      <div className="mb-3">
        <span className="font-serif text-2xl text-neutral-900">12</span>
      ...
      <div className="flex flex-wrap gap-1">
        {langs.map((l) => (
          <span
            key={l}
            className="rounded border border-neutral-300 bg-neutral-50 px-1.5 py-0.5 font-mono text-[9px] text-neutral-600"
          >
            {l}
          </span>
        ))}
