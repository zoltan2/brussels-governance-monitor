...
**Die Hitzewelle vom Juni 2026.** Vom 17. Juni bis Anfang Juli 2026 durchlief Brüssel eine außergewöhnlich frühe Hitzewelle, mit Höchsttemperaturen über 36-37 °C und nächtlichen Minima, die in den Großstädten nicht unter 25-27 °C sanken. Das IRM setzte Belgien auf Orangestufe. Ihre gesundheitliche Bilanz sowie die der beiden folgenden Wellen wird weiter unten dargestellt.
...
**Übersterblichkeit im Sommer 2026 (Sciensano).** Die am 2. September 2026 veröffentlichte konsolidierte Bilanz zählt drei Hitzewellen und rund 2.935 zusätzliche Todesfälle landesweit. Für Brüssel: 196 zusätzliche Todesfälle während der Juniwelle, eine Zahl, die seit den 159 vom 8. Juli und den 188 vom 17. Juli zweimal nach oben korrigiert wurde; 42 während der zweiten Welle vom 4. bis 17. Juli; keine Übersterblichkeit während der dritten vom 28. Juli bis 16. August. Also mehr als zweihundert zusätzliche Todesfälle im Sommer allein für die Region Brüssel. Konfidenz: `official`.
...
Mehrere Unsicherheitspunkte bleiben bestehen. Die VITO-Kartierung von 2018 bleibt die offizielle Referenz für die Brüsseler Hitzeinsel: Keine Aktualisierung nach 2018 wurde in den konsultierten Quellen bestätigt, was die Fähigkeit zur Beobachtung jüngerer Entwicklungen begrenzt. Das Paar "Brüssel-Canberra" aus der Studie Bastin et al. stammt aus der interaktiven Karte und medialen Berichten: Es wurde nicht aus der primären Datentabelle der Studie gelesen. Schließlich existiert die Brüsseler Aufschlüsselung der Übersterblichkeit inzwischen, veröffentlicht für jede Hitzewelle des Sommers 2026. Sie wurde allein für die Juniepisode jedoch dreimal in zwei Monaten korrigiert: Die konsolidierten Zahlen einer Saison liegen erst im darauffolgenden Herbst vor.
...
**Kein öffentliches Freibad seit Mai 2025.** Das Freibad Flow (Anderlecht, am Kanal) schloss Ende Mai 2025 endgültig seine Pforten (Pool is Cool / swim.brussels). Es war das einzige Freibad der Brüsseler Region. Projekte werden untersucht (Kanal Quartier Nord, Neerpede, Uccle), aber keines hatte am 26. Juni 2026 einen bestätigten festen Zeitplan oder ein festes Budget. Die Fachpresse stellt fest, dass diese Situation bis 2029 andauern könnte. Konfidenz: `official` (Schließung Flow, Pool is Cool); `unconfirmed` (Zeitplan der Projekte, Horizont 2029).
