...
changeType: updated
digestHeadline: "Überflug: nördliche Viertel im Landekorridor 07L"
changeSummary: "Hinweis zum Fluglärm hinzugefügt: Die nördlichen Viertel der Stadt Brüssel (Nordviertel, Thurn & Taxis, nördliches Laeken außerhalb der königlichen Sperrzone von 1 500 m) liegen im Anflugkorridor RNP-07L (route Crucke). Bis zum 28. Mai 2026 hat sich die Stadt den interkommunalen Gerichtsverfahren von Koekelberg, Molenbeek-Saint-Jean, Schaerbeek, Evere und Anderlecht (noch) nicht angeschlossen. Siehe Dossier Überflug von Brüssel."
---
