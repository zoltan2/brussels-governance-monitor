...
changeType: updated
changeSummary: "Towards a socially two-tier LEZ: on 11 June the Brussels government approved, in first reading, two exemption scenarios for beneficiaries of the increased reimbursement status (the BIM status, which covers roughly three in ten Brussels residents) — either a full exemption, or one reserved for Brussels-based BIM holders who work and have at least three dependants. The texts go to the Council of State; second reading after the summer, with the government still divided. Meanwhile the enforcement calendar continues: more than 13,000 Euro 5 diesel and Euro 2 petrol vehicles, already warned, face a EUR 350 fine from 1 July."
---
