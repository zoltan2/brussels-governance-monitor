...
metrics:
  ...
  - label: "Bezieher des Eingliederungseinkommens"
    value: "~38 000"
    unit: "Personen"
    source: "ÖPD Soziale Eingliederung / Brulocalis"
    date: "2025-12-31"
...
changeType: new
changeSummary: "Erstveröffentlichung der Fiche Soziales"
---
...
Ende 2025 erhielten rund **38.000 Personen** das RIS in der Region Brüssel. Diese Zahl weist einen strukturellen Aufwärtstrend auf, und die vollen Auswirkungen der Arbeitslosenreform werden sich erst im Laufe des Jahres 2026 zeigen.
...
- Massiv zusätzliches Personal einstellen ohne regionale Finanzierung
- Strukturelle Programme zur sozioprofessionellen Eingliederung starten (regionale Zuständigkeit)
- Das Leistungsangebot an den wachsenden Bedarf anpassen ohne neue Haushaltsmittel
...
Die letzte Zählung durch Bruss'Help im November 2024 erfasste **7.134 obdachlose oder wohnungslose Personen** in Brüssel. Diese Zahl steigt kontinuierlich: Sie lag 2020 bei 5.313 und 2022 bei 6.496.
