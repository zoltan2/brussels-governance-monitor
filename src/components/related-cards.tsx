...
export function RelatedCards({ domain }: { domain: string }) {
  ...
  const labelMap: Record<string, string> = {
    ...
    explainerWhoDecides: th('explainerWhoDecides'),
    explainerCommunities: th('explainerCommunities'),
    sectorConstruction: th('sectorConstruction'),
    sectorTransport: th('sectorTransport'),
    sectorNonprofit: th('sectorNonprofit'),
    sectorHousing: th('sectorHousing'),
    sectorEnvironment: th('sectorEnvironment'),
    sectorHealthSocial: th('sectorHealthSocial'),
    sectorCommerce: th('sectorCommerce'),
    sectorDigital: th('sectorDigital'),
    sectorEducation: th('sectorEducation'),
  };
