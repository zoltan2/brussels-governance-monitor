...
**The June 2026 heatwave.** From 17 June to early July 2026, Brussels went through an exceptionally early heatwave, with maxima exceeding 36-37 °C and nocturnal minima not dropping below 25-27 °C in major cities. IRM placed Belgium under orange code. Its health toll, and that of the two following waves, is detailed below.
...
**Summer 2026 excess mortality (Sciensano).** The consolidated toll published on 2 September 2026 counts three heatwaves and around 2,935 additional deaths nationally. For Brussels: 196 additional deaths during the June wave, a figure revised upwards twice since the 159 announced on 8 July and then the 188 of 17 July; 42 during the second wave, 4 to 17 July; no excess mortality during the third, 28 July to 16 August. That is more than two hundred additional deaths over the summer for the Brussels Region alone. Confidence: `official`.
...
**No public outdoor pool since May 2025.** The Flow pool (Anderlecht, along the canal) definitively closed at the end of May 2025 (Pool is Cool / swim.brussels). It was the only outdoor pool in the Brussels Region. Projects are under study (canal Quartier Nord, Neerpede, Uccle), but none had a confirmed timetable or firm budget as of 26 June 2026. The specialised press notes that this situation could last until 2029. Confidence: `official` (Flow closure, Pool is Cool); `unconfirmed` (project timetable, 2029 horizon).
