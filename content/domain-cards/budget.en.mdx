...
changeType: updated
changeSummary: "Meeting at Val Duchesse on 16 July 2026 for its summer agreement, the government confirmed the one-point cut in personal income tax, applicable from tax year 2028 (2027 income), at a budgetary cost of EUR 58 million per year (of which EUR 3 million borne by municipalities, to be compensated). Separately, the hiring of an IT consultant at EUR 1,258 including VAT per day (EUR 818,320 over 2026-2029, justified by the merger of 6 IT institutions into Atlas.brussels) was criticised in plenary session and refused or postponed by the government in mid-July 2026, a decision consistent with the commitment to reduce reliance on external consultants made in February. Previously: doubling of the Be Home premium from 2027 (EUR 164 to 328 per year, around 200,000 households)."
