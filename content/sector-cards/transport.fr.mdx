---
title: "Transport public : Métro 3 avance, mais les décisions politiques sont gelées"
slug: transport
locale: fr
...
frozenMechanisms:
  - name: "Plan d'investissement STIB"
    ...
    since: "2024-06-09"
  - name: "Arbitrages Métro 3"
    description: "Les travaux de construction du Métro 3 se poursuivent, mais les arbitrages politiques sur le tracé, le budget et le calendrier sont suspendus."
    since: "2024-06-09"
...
stakeholders:
  ...
  - name: "Union syndicale STIB (CSC Transcom / CGSP)"
    type: union
humanImpact: "430 millions de voyages annuels dépendent d'un réseau dont le plan d'investissement est gelé et dont les décisions stratégiques sont suspendues."
...
Les décisions politiques structurantes restent cependant suspendues :

- **Arbitrages budgétaires** : les dépassements de coûts ne peuvent faire l'objet de décisions politiques
- **Calendrier** : les éventuels ajustements du calendrier de mise en service ne peuvent être validés
- **Extension vers le sud** : toute décision sur le prolongement de la ligne vers le sud de Bruxelles est reportée
- **Intégration intermodale** : les décisions sur la connexion du Métro 3 avec les autres réseaux (SNCB, TEC, De Lijn) nécessitent des arbitrages politiques

Le risque est celui d'un chantier qui continue mécaniquement, mais sans la gouvernance politique nécessaire pour traiter les aléas inhérents à un projet de cette envergure.
