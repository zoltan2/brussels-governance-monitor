...
export function DigestReviewClient() {
        ...
        {!isSent && (
          <div className="flex flex-wrap gap-3">
            ...
            <button
              ...
              disabled={status === 'saving' || status === 'approving'}
              className="rounded-md border border-neutral-300 bg-neutral-50 px-4 py-2 text-sm font-medium text-neutral-700 transition-colors hover:bg-neutral-50 disabled:opacity-50"
            >
              Envoyer un test
            </button>
            <button
