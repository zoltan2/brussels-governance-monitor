...
changeType: updated
changeSummary: "Die Brüsseler Regierung billigte einen Rotationstarif von 0,06 EUR pro Minute an öffentlichen Ladestationen nach sechs Stunden Anschlusszeit, gültig ab dem 1. Oktober 2026. Der Bürgermeister von Saint-Gilles fordert das Gewest auf, die zahlreichen baustellenbedingten Umleitungen rund um die Barrière besser zu koordinieren, die er als «unhaltbar» für die Anwohner bezeichnet. Eine vorläufige Einigung beschränkt nun den nächtlichen und wochenendlichen Betrieb von M7-Metrozügen, deren Räder, Ursache der gemeldeten Vibrationen in Woluwe und Auderghem, noch nicht ausgetauscht wurden. Die Jubelfeestbrug in Laken ist nach zwei Jahren Restaurierung wieder für den Verkehr geöffnet. Zuvor: Der autofreie Sonntag findet am 20. September 2026 statt, dem fünfzigsten Jahrestag der Metro, und der Auditor des Staatsrats gab eine negative Stellungnahme zur Umgestaltungsgenehmigung für die Avenue de la Toison d'Or ab."
