...
changeType: updated
changeSummary: "Two years after the announcement of Audi Brussels' closure (effective closure in February 2025, around 3,000 jobs lost), the CSC union published an assessment on 9 July 2026: more than 1,500 former Audi and subcontractor workers have found a new job or entered a training pathway, of whom more than 1,200 people mostly on permanent contracts. Several hundred workers, however, remain without a durable solution according to the union. The 55-hectare Forest site still has no buyer: a takeover by Heylen Warehouses was initially expected before June 2026 but the deadline was not met, and Brussels Economy Minister Laurent Hublet has said he wants to turn the site into an \"economic acceleration zone.\" Previously: the Brussels Parliament voted on 3 July to abolish the Activa scheme (€27M/year, 9,447 beneficiaries in 2025); current entitlements are maintained until 31 December 2026 and a new, \"better targeted\" scheme is announced for 2027 (see the dedicated dossier). The same day, Actiris published its June figures: a 14.6% unemployment rate, 93,445 registered jobseekers (+3% year-on-year), and 34,137 CPAS registrants, up 83.5% year-on-year."
