...
seoTitle: "Abschaffung von Activa.brussels: Ende einer Jobförderung"
slug: activa
locale: de
...
changeSummary: "Korrektur der FAQ: Die Antwort zum Grund der Abschaffung besagt nicht mehr, dass die Aussage der FGTB Brüssel der IDEA-Consult-Evaluierung widerspricht, sondern dass sie darin keine Bestätigung findet, und stellt diese Evaluierung nicht mehr als die einzige verfügbare dar."
...
Die Regierung kündigt ein neues Instrument an, das „**besser zielgerichtet, einfacher und wirksamer**" sein soll (Formulierung von Minister Hublet), im Rahmen des regionalen Ziels einer **Beschäftigungsquote von 70%** bis zum Ende der Legislaturperiode (siehe die Themenkarte [Beschäftigung](/de/bereiche/employment)).
