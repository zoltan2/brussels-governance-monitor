...
frozenMechanisms:
  ...
  - name: "Refinancing of Iriscare agreements"
    description: "Multi-year agreements between Iriscare and care providers that have expired cannot be renewed or revalued."
    since: "2024-06-09"
  - name: "Homelessness plan"
    description: "The structural plan to combat homelessness cannot be adopted or funded beyond the existing winter emergency scheme."
    since: "2024-06-09"
  - name: "Mental health initiatives"
    description: "No new mental health initiative (mobile teams, reception centres, prevention programmes) can be launched."
    since: "2024-06-09"
activeMechanisms:
...
humanImpact: "The agreement announces an administrative reform (merger of pillars) that will affect COCOM/GGC and Iriscare, and a regional drugs commissioner. The budgetary effort will determine the resumption of accreditations, agreements and the homelessness plan. Official DPR not yet published."
lastModified: "2026-02-14"
---

## Government agreement: announced impacts

> **Note**: The official text of the DPR has not yet been published. The measures below are drawn from concordant press sources (RTBF, La Libre, DH, BX1, VRT NWS, BRUZZ). They will be updated once the official document is published.
