...
## Inherited situation (June 2024 – February 2026)
...
- **Car (primary education)**: 35.5% → **32.4%** between 2023 and 2025 (−3.1 percentage points)
- **Active modes** (walking, cycling, scooter): 43% → **45%** (+2 percentage points)
- **Cycling (primary students)**: 3.4% in 2018 → **6.2%** in 2025 (near-doubling)
- **Cycling (school staff)**: 5% → **9.2%** (+84%)
