...
faq:
  - q: "Gibt es Rechenzentren in Brüssel?"
    a: "Ja. Ein großes Rechenzentrum, KevlinX BRU01, ist in Neder-Over-Heembeek in Betrieb, auf einem von citydev.brussels verwalteten regionalen Grundstück und an das Hochspannungsnetz von Elia angeschlossen. Es ist die erste Anlage dieser Größe in der Region Brüssel-Hauptstadt. Belgien verfügt zudem über einen stark wachsenden Bestand an Rechenzentren, der überwiegend außerhalb von Brüssel liegt."
    sources:
...
changeType: updated
changeSummary: "Das künftige europäische Label für Rechenzentren nimmt Gestalt an, und seine Logik passt in einen Satz: Es wird bewerten, ohne zu sanktionieren. Der Entwurf der delegierten Verordnung sieht in seiner überarbeiteten Fassung vom 2. Juli 2026 weder einen Mindestwert noch eine Strafe für eine schlechte Note vor; ein mit G bewerteter Standort bleibt vollkommen regelkonform. Der Hebel ist indirekt, über grüne Finanzierung, öffentliche Aufträge und die künftige EU-Verordnung zu Cloud und künstlicher Intelligenz. Zwei Neuerungen zählen für Brüssel: Das Wasserkriterium erfasst nun entnommenes Süßwasser statt nur Trinkwasser, wodurch Kanalkühlung einfließt, und das Label zeigt neben PUE und WUE fünf weitere Indikatoren, darunter die Anerkennung der Kernenergie. Das erste Label ist für den 15. August 2027 vorgesehen: Zu diesem Datum wird eine öffentliche Zahl zum Wasserverbrauch für einen Standort wie BRU01 vorliegen."
