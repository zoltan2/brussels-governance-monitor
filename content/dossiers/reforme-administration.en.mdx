...
changeType: updated
changeSummary: "The Minister for the Public Service, Dirk De Smedt, announced on 3 July the launch of a regional 'pool de compétences' ('competentiepool'), intended to redirect staff from overstaffed administrations toward services short of personnel, in the context of the hiring freeze in force since December 2023. Two tracks are planned: a fast track (assignment within 4 to 8 weeks) and a requalification track (6 to 18 months), with full operationalisation targeted for 30 June 2027. Social dialogue starts on 14 July 2026; trade unions are asking for prompt clarity on which administrations are affected. Previously: cutting consultancy fees (up to EUR 67 million/year by 2029) remains a key lever of the savings trajectory."
---
