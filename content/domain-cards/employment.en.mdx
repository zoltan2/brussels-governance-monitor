...
changeType: updated
changeSummary: "In June 2026, 35,118 Brussels residents were still receiving full unemployment benefits, 43.5% fewer than a year earlier. It is the steepest fall of the three regions, thirteen points above the national average (ONEM figures published on 30 July). That drop does not measure a return to work: over the same period, the unemployment rate calculated by Actiris rose by 0.31 percentage point to 14.6%, and 31,850 Brussels jobseekers, 34% of them, are now registered with a public social welfare centre, a share up by more than 70% in one year. People leave the statistics through the end of entitlement, not through employment. The cost shifts from the federal unemployment insurance budget to the welfare centres, funded by the municipalities and the Joint Community Commission."
