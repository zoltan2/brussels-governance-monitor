...
changeType: updated
changeSummary: "1. Regierungskrise (T+50, 2.-4. April): LEZ spaltet PS-Groen-Anders, Sondersitzung, Lösung am 4. April. Subventionen BRAL/IEB von De Smedt verweigert (Bedingung: keine Subventionen an Organisationen, die die Region verklagen)."
