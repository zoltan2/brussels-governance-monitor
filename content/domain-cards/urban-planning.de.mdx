...
changeType: updated
changeSummary: "Auderghem erklärt den großen regionalen Immobilienprojekten den Krieg: Die Gemeinde wird eine Anwaltskanzlei beauftragen, um Projekte, die sie als zu dicht erachtet, systematisch zu blockieren (schwarze Liste erstellt). Der Bausektor beklagt ein institutionelles Durcheinander zwischen Gemeinde und Region. Gleichzeitig präsentiert die Brüsseler Regierung große Ambitionen für das Heysel-Plateau (internationales Kongresszentrum)."
