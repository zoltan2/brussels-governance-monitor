...
Le cabinet du ministre **Laurent Hublet** (Engagés) défend une lecture textuelle. « L'exclusion ne résulte pas d'une nouvelle orientation politique, mais de l'application d'une réglementation adoptée sous la précédente législature », indique le cabinet à la presse le 7 mai. Le ministre se dit « ouvert à d'éventuelles adaptations ou à une période transitoire », sans en formaliser le contenu.
...
- **Articulation des dispositifs.** Quelle articulation pérenne entre titres-services classiques, ESMI et travail adapté pour les publics aux profils intermédiaires (insertion + handicap, insertion + perte d'autonomie) ?
