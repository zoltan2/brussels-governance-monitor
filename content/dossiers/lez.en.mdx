...
changeType: updated
changeSummary: "The enforcement side of the LEZ has produced its first set of figures. In the first half of 2026, checks generated 25,905 warnings to drivers of Euro 5 diesel and Euro 2 petrol vehicles, banned across the Region since 1 January. Since 1 July, 1,890 fines have been issued and sent, for 89,152.50 EUR collected, corresponding to about 255 fines actually paid: a little over 13% of the fines sent, with some payment deadlines still running. The pool concerned is estimated at 29,000 Brussels vehicles and some 630,000 nationwide. This record reads alongside the state of the network underpinning it: 23% of regional ANPR cameras are out of service and only 48% of their captures are usable."
---
