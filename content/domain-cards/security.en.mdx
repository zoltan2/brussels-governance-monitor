...
changeType: updated
changeSummary: "The total SIAMU strike that began on 21 July 2026 continued on 22 July, with only around 30% of operational service available. The minister-president met with the unions on 22 July without reaching an agreement; the joint union front (CGSP) considers the government's proposals (40 recruitments by the end of the year) insufficient given an expected loss of 60 to 70 firefighters over the year. Previously: SIAMU's joint union front had called on 19 July 2026 for a total 24-hour strike on 21 July 2026, extending the already-documented staffing conflict (shift reorganisation plan of 28 May, joint management-union call of 11 June)."
