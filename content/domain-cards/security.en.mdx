...
changeType: updated
changeSummary: "Military deployment concrete: 200 soldiers from 23 March (Brussels + Antwerp), 3 months then 90. FIPA patrols from April."
...
## Military deployment: 200 soldiers on the streets (23 March 2026)

On 16 March 2026, federal Interior Minister Bernard Quintin (MR) and Defence Minister Theo Francken (N-VA) announced the deployment of **military personnel outside synagogues and Jewish schools** in Belgium, following the attack on the Liege synagogue (10 March) and the escalation of the antisemitic threat in Europe.

On **23 March 2026**, the operation enters into force: a maximum of **200 soldiers** are deployed in **Brussels and Antwerp**, with a subsequent extension to Liege. The missions include:

- **Static surveillance** of sites frequented by the Jewish community (synagogues, schools)
- **Railway police support**: joint patrols in train stations and STIB/MIVB stops
...
Joint patrols in Brussels will effectively start only from **April 2026** (BX1). After **three months**, the contingent will be reduced to **90 soldiers**.

Belgium's threat level remains at **level 3 of 4** ("serious"). Justice Minister Nicole Verlinden (CD&V) criticised the initial announcement, stating it had not been discussed in the Council of Ministers.

Sources: RTBF (16 and 19 March 2026), BX1, La Libre, DH (23 March 2026).
