...
changeType: updated
changeSummary: "Brüsseler Non-Profit-Sektor: Im Anschluss an die nationale Mobilisierung vom 6. Juni (nach der Abstimmung über das FWB-Programmgesetz) schlagen Arbeitgeber- und Arbeitnehmervertreter Alarm — mehrere Brüsseler Verbände stehen trotz der Einsetzung der neuen Regionalregierung weiterhin vor Haushaltsunsicherheiten (Konventionen und Zulassungen noch nicht stabilisiert). Zuvor: Demonstration am 4. Juni in Brüssel (mehrere Tausend Beschäftigte aus Gesundheitswesen, Sozialwesen und Soziokultur) für einen föderalen Sozialvertrag und die Refinanzierung des ACS-Sektors."
