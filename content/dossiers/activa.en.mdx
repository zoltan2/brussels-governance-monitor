...
seoTitle: "Activa.brussels abolished: the end of an employment subsidy"
slug: activa
locale: en
...
changeSummary: "FAQ correction: the answer on the reason for abolition no longer says the FGTB Brussels statement contradicts the IDEA Consult evaluation, but that it is not confirmed by it, and no longer presents that evaluation as the only one available."
