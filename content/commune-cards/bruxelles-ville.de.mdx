...
changeSummary: "Die Kabinette des Kollegiums der Stadt Brüssel zählen 93,2 Vollzeitäquivalente. Die Zahl ist eine Berechnung der Opposition aus den von der Stadt am 1. August veröffentlichten Daten, denn die Stadt selbst nannte keine Gesamtsumme. Die Obergrenze der vorigen Legislaturperiode lag bei 82 Mitarbeitenden, bei einem Kollegium mit damals einem Schöffen mehr. Der Umschwung geht auf ein Anfang 2025 angenommenes Punktesystem zurück, das die Begrenzung nach Status oder Diplom ersetzte. Die Opposition stellt die Zahl der Schließung einer Schule und eines Kulturzentrums sowie der Nichtbesetzung frei werdender Stellen gegenüber."
