...
changeType: updated
changeSummary: "The Brussels labour market deteriorated in 2025, according to the IBSA economic note published on 18 June: resident salaried employment fell for the first time in more than ten years, to 352,200 people at the end of 2025 (4,500 fewer over one year, i.e. −1.3%), while temporary agency work dropped to a level comparable to the 2021 lockdowns and unemployment rose by 4.7% year on year. In the first quarter, 1,412 people excluded from unemployment lodged an appeal. Previously: Brussels remains on the sidelines of the flexi-job boom (3.2% of Belgian beneficiaries) and the Social Summit of 11 June sealed 17 shared priorities with the social partners."
