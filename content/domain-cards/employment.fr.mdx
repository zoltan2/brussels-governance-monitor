...
summary: "Le chômage bruxellois augmente (+4,4 % en un an) pendant que la réforme fédérale exclut 42 000 Bruxellois des allocations. En affaires courantes, la Région ne peut pas lancer de nouveaux programmes d'emploi ni répondre pleinement à la crise."
sectors:
  - associatif
  - construction
sources:
...
changeType: updated
changeSummary: "Ajout données StatBel T3 2025 : taux chômage OIT 13,1% (2× BE), taux emploi 64,9% (le plus bas des 3 Régions)"
