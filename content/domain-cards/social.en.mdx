...
changeType: updated
changeSummary: "Vivalis Social Barometer 2025 published on 15 April 2026: poverty 23% (vs 7% Flanders, 13% Wallonia), 47 304 integration income recipients on 1 January 2025 (> Flanders 45 616 despite 5× smaller population), 6 of the 10 poorest Belgian municipalities are in Brussels (Saint-Josse, Molenbeek, Anderlecht, Koekelberg, Schaerbeek, Ville), 55 572 households on social housing waiting list (+78% in 15 years), ~50 000 undocumented persons (4% pop.), homeless count +25% in 2 years (9 777), 1 child in 3 in poverty. BRUZZ complement (15 April): 14 246 Brussels students on integration income, more than all of Flanders (10 064)."
