...
**La canicule de juin 2026.** Du 17 juin au début juillet 2026, Bruxelles a traversé une vague de chaleur exceptionnellement précoce, avec des maxima dépassant 36-37 °C et des minimas nocturnes ne descendant pas sous 25-27 °C dans les grandes villes. L'IRM a placé la Belgique en code orange. Son bilan sanitaire, et celui des deux vagues suivantes, est détaillé plus bas.
...
**Surmortalité de l'été 2026 (Sciensano).** Le bilan consolidé publié le 2 septembre 2026 recense trois vagues de chaleur et environ 2 935 décès supplémentaires au niveau national. Pour Bruxelles : 196 décès supplémentaires lors de la vague de juin, chiffre corrigé deux fois à la hausse depuis les 159 annoncés le 8 juillet, puis les 188 du 17 juillet ; 42 lors de la deuxième vague, du 4 au 17 juillet ; aucune surmortalité lors de la troisième, du 28 juillet au 16 août. Soit plus de deux cents décès supplémentaires sur l'été pour la seule Région bruxelloise. Confiance : `official`.
...
Plusieurs points d'incertitude demeurent. La cartographie VITO 2018 reste la référence officielle pour l'îlot de chaleur bruxellois : aucune mise à jour post-2018 n'a été confirmée dans les sources consultées, ce qui limite la capacité à observer les évolutions récentes. La paire « Bruxelles-Canberra » de l'étude Bastin et al. est issue de la carte interactive et de relais médiatiques : elle n'a pas été lue dans le tableau de données primaire de l'étude. Enfin, la ventilation bruxelloise de la surmortalité existe désormais, publiée pour chaque vague de chaleur de l'été 2026. Mais elle a été révisée trois fois en deux mois pour le seul épisode de juin : les chiffres consolidés d'une saison ne sont pas disponibles avant la rentrée qui la suit.
...
**Aucune piscine extérieure publique depuis mai 2025.** La piscine Flow (Anderlecht, le long du canal) a fermé définitivement ses portes fin mai 2025 (Pool is Cool / swim.brussels). Il s'agissait de la seule piscine en plein air de la Région bruxelloise. Des projets sont à l'étude (canal Quartier Nord, Neerpede, Uccle), mais aucun n'avait de calendrier ni de budget ferme confirmé au 26 juin 2026. La presse spécialisée note que cette situation pourrait durer jusqu'en 2029. Confiance : `official` (fermeture Flow, Pool is Cool) ; `unconfirmed` (calendrier des projets, horizon 2029).
