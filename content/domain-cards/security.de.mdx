...
changeType: updated
changeSummary: "Die Gemeinden Schaerbeek und Saint-Josse-ten-Noode verlängern die nächtliche Schließung der Handelsbetriebe im Quartier Brabant um drei Monate bis Ende September 2026 und passen sie auf Grundlage von Rückmeldungen aus dem Terrain an: Schaerbeek lockert die Schließungszeit auf 3 Uhr an Wochenenden und Vorabenden von Feiertagen (Gemeinderatsabstimmung am 26. Juni), während Saint-Josse am 30. Juni abstimmt, ohne die Zeiten zu ändern, aber die Rue Royale aus dem Perimeter ausschließt. Die Kollegien begründen die Verlängerung mit einem Rückgang des Anteils der Gewalttaten zwischen 1 Uhr und 6 Uhr und verlängern auch die begleitenden Steuerbefreiungen. Zuvor: Die Regionalregierung hatte am 16. Juni die Schaffung eines regionalen Drogenkommissars bestätigt und einen Bahnhofsplan von zehn Millionen pro Jahr für Nord und Midi gebilligt."
...
**Zahlenmassige Begrundung** der Kollegien: Der Anteil der **Gewalttaten zwischen 1 Uhr und 6 Uhr** soll von **dreiundzwanzig Prozent im ersten Quartal auf sieben Komma sieben Prozent im Mai** gesunken sein, und die Raubdelikte mit Gewalt sollen zuruckgegangen sein (von funfzehn auf sieben). Diese Feststellung knupft an die erste Bilanz vom April an (Anteil der nachtlichen Ubergriffe von zwanzig auf elf Komma funf Prozent zuruckgegangen, siehe vorherigen Abschnitt). Laut den Gemeinden unterstutzten etwa drei von vier Anwohnern die Massnahme.
