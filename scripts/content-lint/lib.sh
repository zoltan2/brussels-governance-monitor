...
# Un slug de dossier modifié (localizedSlugs, slug canonique, suppression) doit
# livrer sa redirection permanente dans src/lib/redirects-301.ts : règle
# MANDATORY de velite.config.ts, sans garde jusqu'au 24/09/2026. Compare les
# URL servies au merge-base et dans l'arbre de travail ; le message donne
# l'entrée exacte à ajouter. Logique : src/lib/slug-redirects.ts.
# $1 = base_ref. Ne lit pas stdin.
check_slug_redirects() {
