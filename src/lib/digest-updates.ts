...
// Réexporté : `leadSplit` vit désormais dans un module pur (sans accès au contenu ni
// à Resend), pour que la barre « Dernière mise à jour » et ses tests l'importent seuls.
export { leadSplit };
