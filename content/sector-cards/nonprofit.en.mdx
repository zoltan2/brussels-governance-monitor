...
humanImpact: "The agreement announces a review of discretionary subsidies and an administrative reform (merger of pillars) that will affect the sector's agreements and accreditations. Strengthened activation via Actiris directly impacts the 80,000 nonprofit jobs. Official DPR not yet published."
lastModified: "2026-02-14"
---

## Government agreement: announced impacts

> **Note**: The official text of the DPR has not yet been published. The measures below are drawn from corroborating press sources (RTBF, La Libre, DH, BX1, VRT NWS, BRUZZ). They will be updated once the official document is published.
