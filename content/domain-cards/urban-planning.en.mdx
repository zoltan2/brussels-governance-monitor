...
changeType: updated
changeSummary: "Heritage and major works: on 17 June, the Region issued the planning permit authorising the partial dismantling of the Palais du Midi, with strengthened heritage safeguards; this is the lock that unblocks the metro tunnel, but the ARAU association announces it intends to challenge the demolition. On 18 June, the Constitutional Court annulled the April 2024 ordinance that allowed the mandatory public opening of the Palais Stoclet (Art Nouveau, UNESCO, Woluwe-Saint-Pierre) to be imposed, for lack of sufficient protection of the right to property. The same day, the government approved a Stations Plan of ten million per year to upgrade the surroundings of the North and Midi stations."
