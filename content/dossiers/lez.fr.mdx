...
changeType: updated
changeSummary: "Conseil d'État critique la baisse des amendes LEZ (standstill, santé) — risque juridique pour le regeerakkoord Dilliès"
---
...
Le regeerakkoord Dilliès prévoit également des amendes réduites (80 EUR/infraction, pass annuel à 350 EUR). L'ordonnance ou l'arrêté d'exécution correspondant n'a pas encore été publié. Le risque juridique est réel si le gouvernement suit la même logique que la proposition MR.
