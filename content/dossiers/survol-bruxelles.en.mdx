...
changeType: updated
changeSummary: "Brussels mayors to meet the federal Mobility minister in early June 2026 on the nuisances of the new approach route (BRUZZ, 19 May). The regional Security minister publicly calls on the Flemish Region to take its responsibilities on Brussels Airport (BRUZZ, 18 May). In the background: the Brussels State Secretary's proposal of 12 May to join the municipalities' judicial actions against RNP-07L."
---
