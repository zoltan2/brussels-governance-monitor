...
<Signal>
Les dix-neuf CPAS bruxellois sont les opérateurs publics de dernier recours en matière d'aide sociale, soumis à trois autorités sans coordination native (fédéral, Cocom, communes) — ce qui explique les frottements actuels.
</Signal>
...
<Signal>
La réforme fédérale du chômage entrée en vigueur le 1ᵉʳ janvier 2026 fait basculer ~35 800 Bruxellois exclus vers le RIS — donc vers les CPAS — en quatre vagues, avec une compensation fédérale en tension entre 234 M€ (gouvernement) et 300 M€ (Cour des comptes).
</Signal>
