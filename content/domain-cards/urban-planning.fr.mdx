...
changeType: updated
changeSummary: "Tour & Taxis : classement du château d'eau et de la sous-station électrique comme patrimoine (mars 2026)."
...
## Réformes réglementaires (DPR, chapitre 6)

La DPR prévoit une refonte en profondeur du cadre urbanistique bruxellois :

- **COBAT** : refonte globale du Code Bruxellois de l'Aménagement du Territoire, le texte-cadre régissant l'urbanisme régional
- **RRU** : révision du Règlement Régional d'Urbanisme, qui fixe les normes applicables à tous les projets de construction
- **PRAS** : révision partielle du Plan Régional d'Affectation du Sol, pour adapter les affectations aux besoins actuels
- **MyPermit** : digitalisation complète du parcours de demande de permis via la plateforme urban.brussels
- **DLUU** : instauration d'un délai légal d'urbanisme unique, pour réduire l'incertitude sur les délais de traitement

Ces réformes n'ont pas encore fait l'objet d'ordonnances ou de projets de texte publiés.
